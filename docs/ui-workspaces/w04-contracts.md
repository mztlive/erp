...
遵循 `erp-ui-design.md` §4.5.1：`object-chrome` + 唯一 compact `DocumentHeader`，禁止「合同 · 单号」与客户名双标题。

```text
┌ PageHeader object-chrome：销售 › 合同 › HT-2026-0088   [返回] [打印] ─┐
├ DocumentHeader compact：东方企业 [生效]                               │
│  HT-2026-0088 · v3 · 有效期摘要      [新建销售单] [创建新修订] [更多] │
...
- [x] 1440×900 下页头、指标、工具栏和分页同时存在时至少露出 6–8 条 36px 数据行。
