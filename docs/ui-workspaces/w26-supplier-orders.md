...
- 不修改供应商商品映射、固定供应关系和发布版本；分别进入 W21、W22。
...
| 商品明细 | 商品快照、数量、供应商商品、发布/供给数据版本、下单成本快照、合计数量与合计成本行 | `supplier_fulfillment_item` | 一条商城明细只属于一个供应商子订单，不显示可改供应商；版本代号（SV-/PV-）不原样上屏 |
...
| 供应商商品与供给 | W21 / W22 | SKU、供应商商品、供给/发布版本 | 返回保持订单页签 |
