...
- 商品名称、规格、分类、图片和说明；
- 来源报价、建议零售价、运费和其他费用；来源报价未确认前不等于采购成本；
- 可供区域、库存或可供状态；
- 预计发货时间和售后说明；
- 供应商商品版本、更新时间和原始数据摘要；
- 支持的商品级接口能力。
...
品牌/单位/规格使用同一套字典与规格维度编辑；商品能力为多选框组。单独维护供应商独有
「来源供给」字段；手工录入使用全页详情即编辑，保存形成来源修订。中心页不展示来源
版本差异、供给版本时间线与发布影响。入池**仅映射已有公司 SKU**，不提供从来源新建
公司商品；报价与可供条件、商品能力等不进入公司主档。详见
