...
| G5 | D24 | `supplier_offering` | `supplier_offering`、`supplier_offering_revision`、`supplier_offering_availability`、`supplier_offering_command`；公司 SKU 是唯一商品主数据 | D09、D10 | W21 |
...
| W21 | 供应商供给（添加供给、修订条款、更新可供） | `supplier-offerings` | D24 |
