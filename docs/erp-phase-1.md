...
- 卡券销售单在 ERP 的生效顺序为：销售提交 → 销售领导审批 → 运营审批 → 销售单生效；
...
采购二次确认是销售单生效的闸门：销售单生效代表公司对客户作出履约承诺，**必须**在生效前完成二次确认；**禁止**在二次确认通过前将销售单置为已生效。
...
驳回发生在生效之前，**禁止**对驳回单使用变更单。销售单生效之后出现的成本变化或供应商问题，**必须**按第 6.3 节走采购变更单和销售变更单，**禁止**回到二次确认。
...
- 执行投影**必须**由 ERP 卡券销售单完成两级审批并生效时自动发出，**禁止**由运营在商城重新录入销售单；
