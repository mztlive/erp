...
| 状态 | 第一期使用固定业务状态机；审批定义按代码注册并版本化，不建设管理员可视化流程配置；角色和权限配置化 | 5.2、10、11.1、`approval-workflow-contract.md` |
...
| **审批与待办合同** `approval-workflow-contract.md` | 统一约定审批定义、运行实例、步骤分派、待办责任、多级推进和 BPM 接入边界 |
