...
| 禁用词 | 出现位置 | 替换为 |
| --- | --- | --- |
| 打开专用处理器 | `mock/work-items.ts` ×6、`mock/workspace-pages.ts` ×3、`queue-workspace-page.tsx:333/336/439`、`unified-task-queue-page.tsx:1175/1456` | **必须**按任务类型使用动作词（见 §3.1）；未登记类型**必须**用兜底「前往处理」 |
