...
本计划用于把当前 backend 的 entities/database/services 生产代码迁移为领域 crate，缩小日常增量编译范围。执行模式为逐阶段硬切；阶段 00–02 已达「本地门禁通过」，阶段 03 阻塞，04–17 仍未开始。
...
| 03 | [工作流与组合层](03-workflow-composition.md) | erp-workflow, erp-processes, erp-read-models | 阻塞 |
