//! Owned MongoDB repository for [`entities::supplier::SupplierQualification`].
...
pub struct SupplierQualificationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierQualification>,
}
...
impl<'a> SupplierQualificationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierQualification> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierQualification,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierQualification>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierQualification,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierQualification: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierQualification>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier::SupplierQualification>>
    where
