//! Owned MongoDB repository for [`entities::receivable::ReceivableEntryOffset`].
...
pub struct ReceivableEntryOffsetRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::ReceivableEntryOffset>,
}
...
impl<'a> ReceivableEntryOffsetRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::ReceivableEntryOffset> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::ReceivableEntryOffset,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::ReceivableEntryOffset>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::ReceivableEntryOffset,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::ReceivableEntryOffset: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::ReceivableEntryOffset>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::ReceivableEntryOffset>>
    where
