//! Owned MongoDB repository for [`entities::purchase_order::PurchaseOrderSubmission`].
...
pub struct PurchaseOrderSubmissionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::purchase_order::PurchaseOrderSubmission>,
}
...
impl<'a> PurchaseOrderSubmissionRepository<'a> {
    ...
    /// Returns the MongoDB collection handle for `PurchaseOrderSubmission`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::purchase_order::PurchaseOrderSubmission> {
    ...
    pub async fn create(
        &self,
        entity: &entities::purchase_order::PurchaseOrderSubmission,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::purchase_order::PurchaseOrderSubmission>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::purchase_order::PurchaseOrderSubmission,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::purchase_order::PurchaseOrderSubmission: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::purchase_order::PurchaseOrderSubmission>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::purchase_order::PurchaseOrderSubmission>,
    >
    where
