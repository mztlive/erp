//! Owned MongoDB repository for [`entities::payable::PayableAccount`].
...
pub struct PayableAccountRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::PayableAccount>,
}
...
impl<'a> PayableAccountRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::PayableAccount> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::PayableAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::PayableAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::PayableAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::PayableAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::PayableAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::PayableAccount>>
    where
