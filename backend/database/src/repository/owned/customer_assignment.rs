//! Owned MongoDB repository for [`entities::customer::CustomerAssignment`].

/// Owned repository for `CustomerAssignment`.
///
...
pub struct CustomerAssignmentRepository<'a> {
    inner: persistence_core::Repository<'a, entities::customer::CustomerAssignment>,
}

impl<'a> CustomerAssignmentRepository<'a> {
    /// Creates a `CustomerAssignment` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CustomerAssignment`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CustomerAssignment`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::customer::CustomerAssignment> {
    ...
    pub async fn create(
        &self,
        entity: &entities::customer::CustomerAssignment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::customer::CustomerAssignment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::customer::CustomerAssignment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::customer::CustomerAssignment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::customer::CustomerAssignment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::customer::CustomerAssignment>>
    where
