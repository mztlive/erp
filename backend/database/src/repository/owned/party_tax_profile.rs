//! Owned MongoDB repository for [`entities::party::PartyTaxProfile`].
...
pub struct PartyTaxProfileRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::PartyTaxProfile>,
}
...
impl<'a> PartyTaxProfileRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::PartyTaxProfile> {
    ...
    pub async fn create(
        &self,
        entity: &entities::party::PartyTaxProfile,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::PartyTaxProfile>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::PartyTaxProfile,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::PartyTaxProfile: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::PartyTaxProfile>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::PartyTaxProfile>>
    where
