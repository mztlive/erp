//! Owned MongoDB repository for [`entities::integration_ops::IntegrationErrorTask`].
...
pub struct IntegrationErrorTaskRepository<'a> {
    inner: persistence_core::Repository<'a, entities::integration_ops::IntegrationErrorTask>,
}
...
impl<'a> IntegrationErrorTaskRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::integration_ops::IntegrationErrorTask> {
    ...
    pub async fn create(
        &self,
        entity: &entities::integration_ops::IntegrationErrorTask,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::integration_ops::IntegrationErrorTask>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::integration_ops::IntegrationErrorTask,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::integration_ops::IntegrationErrorTask: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::integration_ops::IntegrationErrorTask>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::integration_ops::IntegrationErrorTask>>
    where
