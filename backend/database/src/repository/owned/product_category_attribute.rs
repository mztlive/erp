//! Owned MongoDB repository for [`entities::catalog::ProductCategoryAttribute`].
...
pub struct ProductCategoryAttributeRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::ProductCategoryAttribute>,
}
...
impl<'a> ProductCategoryAttributeRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::ProductCategoryAttribute> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::ProductCategoryAttribute,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::ProductCategoryAttribute>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::ProductCategoryAttribute,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::ProductCategoryAttribute: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::ProductCategoryAttribute>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::ProductCategoryAttribute>>
    where
