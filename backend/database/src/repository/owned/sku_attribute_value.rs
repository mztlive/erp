//! Owned MongoDB repository for [`entities::catalog::SkuAttributeValue`].
...
pub struct SkuAttributeValueRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::SkuAttributeValue>,
}
...
impl<'a> SkuAttributeValueRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::SkuAttributeValue> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::SkuAttributeValue,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::SkuAttributeValue>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::SkuAttributeValue,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::SkuAttributeValue: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::SkuAttributeValue>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::SkuAttributeValue>>
    where
