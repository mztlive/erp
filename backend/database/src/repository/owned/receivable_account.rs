//! Owned MongoDB repository for [`entities::receivable::ReceivableAccount`].
...
pub struct ReceivableAccountRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::ReceivableAccount>,
}
...
impl<'a> ReceivableAccountRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::ReceivableAccount> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::ReceivableAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::ReceivableAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::ReceivableAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::ReceivableAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::ReceivableAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::ReceivableAccount>>
    where
