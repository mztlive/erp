//! Owned MongoDB repository for [`entities::catalog::SkuAttribute`].
...
pub struct SkuAttributeRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::SkuAttribute>,
}
...
impl<'a> SkuAttributeRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::SkuAttribute> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::SkuAttribute,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::SkuAttribute>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::SkuAttribute,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::SkuAttribute: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::SkuAttribute>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::SkuAttribute>>
    where
