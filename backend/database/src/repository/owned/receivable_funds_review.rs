//! Owned MongoDB repository for [`entities::receivable::ReceivableFundsReview`].
...
pub struct ReceivableFundsReviewRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::ReceivableFundsReview>,
}
...
impl<'a> ReceivableFundsReviewRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::ReceivableFundsReview> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::ReceivableFundsReview,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::ReceivableFundsReview>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::ReceivableFundsReview,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::ReceivableFundsReview: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::ReceivableFundsReview>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::ReceivableFundsReview>>
    where
