//! Owned MongoDB repository for [`entities::cost::CostEntry`].
...
pub struct CostEntryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::cost::CostEntry>,
}
...
impl<'a> CostEntryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::cost::CostEntry> {
    ...
    pub async fn create(
        &self,
        entity: &entities::cost::CostEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::cost::CostEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::cost::CostEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::cost::CostEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::cost::CostEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::cost::CostEntry>>
    where
