//! Owned MongoDB repository for [`entities::party::Party`].
...
pub struct PartyRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::Party>,
}
...
impl<'a> PartyRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::Party> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::Party>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::Party,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::Party: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::Party>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::Party>>
    where
