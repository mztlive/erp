//! Owned MongoDB repository for [`entities::payable::PayableEntryOffset`].
...
pub struct PayableEntryOffsetRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::PayableEntryOffset>,
}
...
impl<'a> PayableEntryOffsetRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::PayableEntryOffset> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::PayableEntryOffset,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::PayableEntryOffset>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::PayableEntryOffset,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::PayableEntryOffset: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::PayableEntryOffset>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::PayableEntryOffset>>
    where
