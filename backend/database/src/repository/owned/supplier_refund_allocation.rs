//! Owned MongoDB repository for [`entities::supplier_fulfillment::SupplierRefundAllocation`].
...
pub struct SupplierRefundAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_fulfillment::SupplierRefundAllocation>,
}
...
impl<'a> SupplierRefundAllocationRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::supplier_fulfillment::SupplierRefundAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_fulfillment::SupplierRefundAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_fulfillment::SupplierRefundAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_fulfillment::SupplierRefundAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_fulfillment::SupplierRefundAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_fulfillment::SupplierRefundAllocation>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_fulfillment::SupplierRefundAllocation>,
    >
    where
