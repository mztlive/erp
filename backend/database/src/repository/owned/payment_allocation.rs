//! Owned MongoDB repository for [`entities::payable::PaymentAllocation`].
...
pub struct PaymentAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::PaymentAllocation>,
}
...
impl<'a> PaymentAllocationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::PaymentAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::PaymentAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::PaymentAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::PaymentAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::PaymentAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::PaymentAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::PaymentAllocation>>
    where
