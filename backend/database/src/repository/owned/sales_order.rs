//! Owned MongoDB repository for [`entities::sales_order::SalesOrder`].

/// Owned repository for `SalesOrder`.
///
...
pub struct SalesOrderRepository<'a> {
    inner: persistence_core::Repository<'a, entities::sales_order::SalesOrder>,
}

impl<'a> SalesOrderRepository<'a> {
    /// Creates a `SalesOrder` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesOrder`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesOrder`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::sales_order::SalesOrder> {
    ...
    pub async fn create(
        &self,
        entity: &entities::sales_order::SalesOrder,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::sales_order::SalesOrder>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::sales_order::SalesOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::sales_order::SalesOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::sales_order::SalesOrder>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::sales_order::SalesOrder>>
    where
