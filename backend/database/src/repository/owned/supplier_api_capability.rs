//! Owned MongoDB repository for [`entities::supplier_api::SupplierApiCapability`].
...
pub struct SupplierApiCapabilityRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_api::SupplierApiCapability>,
}
...
impl<'a> SupplierApiCapabilityRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_api::SupplierApiCapability> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_api::SupplierApiCapability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_api::SupplierApiCapability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_api::SupplierApiCapability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_api::SupplierApiCapability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_api::SupplierApiCapability>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier_api::SupplierApiCapability>>
    where
