//! Owned MongoDB repository for [`entities::supplier_offering::SupplierOfferingAvailability`].
...
pub struct SupplierOfferingAvailabilityRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_offering::SupplierOfferingAvailability>,
}
...
impl<'a> SupplierOfferingAvailabilityRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::supplier_offering::SupplierOfferingAvailability> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_offering::SupplierOfferingAvailability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_offering::SupplierOfferingAvailability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_offering::SupplierOfferingAvailability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_offering::SupplierOfferingAvailability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_offering::SupplierOfferingAvailability>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_offering::SupplierOfferingAvailability>,
    >
    where
