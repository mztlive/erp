//! Owned MongoDB repository for [`entities::returns::PurchaseReturnOrder`].
...
pub struct PurchaseReturnOrderRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::PurchaseReturnOrder>,
}
...
impl<'a> PurchaseReturnOrderRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::PurchaseReturnOrder> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::PurchaseReturnOrder,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::PurchaseReturnOrder>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::PurchaseReturnOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::PurchaseReturnOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::PurchaseReturnOrder>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::PurchaseReturnOrder>>
    where
