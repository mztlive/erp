//! Owned MongoDB repository for [`entities::supplier::SupplierCapability`].
...
pub struct SupplierCapabilityRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierCapability>,
}
...
impl<'a> SupplierCapabilityRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierCapability> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierCapability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierCapability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierCapability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierCapability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierCapability>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier::SupplierCapability>>
    where
