//! Owned MongoDB repository for [`entities::contract::ContractRevision`].
...
pub struct ContractRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::contract::ContractRevision>,
}
...
impl<'a> ContractRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::contract::ContractRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::contract::ContractRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::contract::ContractRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::contract::ContractRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::contract::ContractRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::contract::ContractRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::contract::ContractRevision>>
    where
