//! Owned MongoDB repository for [`entities::document_registry::DocumentParticipant`].
...
pub struct DocumentParticipantRepository<'a> {
    inner: persistence_core::Repository<'a, entities::document_registry::DocumentParticipant>,
}
...
impl<'a> DocumentParticipantRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::document_registry::DocumentParticipant> {
    ...
    pub async fn create(
        &self,
        entity: &entities::document_registry::DocumentParticipant,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::document_registry::DocumentParticipant>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::document_registry::DocumentParticipant,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::document_registry::DocumentParticipant: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::document_registry::DocumentParticipant>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::document_registry::DocumentParticipant>,
    >
    where
