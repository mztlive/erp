//! Owned MongoDB repository for [`entities::supplier_offering::SupplierOffering`].
...
pub struct SupplierOfferingRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_offering::SupplierOffering>,
}
...
impl<'a> SupplierOfferingRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_offering::SupplierOffering> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_offering::SupplierOffering,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_offering::SupplierOffering>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_offering::SupplierOffering,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_offering::SupplierOffering: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_offering::SupplierOffering>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier_offering::SupplierOffering>>
    where
