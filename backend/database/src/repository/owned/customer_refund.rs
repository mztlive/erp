//! Owned MongoDB repository for [`entities::returns::CustomerRefund`].
...
pub struct CustomerRefundRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::CustomerRefund>,
}
...
impl<'a> CustomerRefundRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::CustomerRefund> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::CustomerRefund,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::CustomerRefund>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::CustomerRefund,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::CustomerRefund: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::CustomerRefund>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::CustomerRefund>>
    where
