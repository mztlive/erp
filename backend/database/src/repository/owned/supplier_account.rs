//! Owned MongoDB repository for [`entities::supplier::SupplierAccount`].
...
pub struct SupplierAccountRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierAccount>,
}
...
impl<'a> SupplierAccountRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierAccount> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier::SupplierAccount>>
    where
