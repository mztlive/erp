//! Owned MongoDB repository for [`entities::receivable::ReceiptAllocation`].
...
pub struct ReceiptAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::ReceiptAllocation>,
}
...
impl<'a> ReceiptAllocationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::ReceiptAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::ReceiptAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::ReceiptAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::ReceiptAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::ReceiptAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::ReceiptAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::ReceiptAllocation>>
    where
