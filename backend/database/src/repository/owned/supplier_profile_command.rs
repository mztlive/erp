//! Owned MongoDB repository for [`entities::supplier::SupplierProfileCommand`].
...
pub struct SupplierProfileCommandRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierProfileCommand>,
}
...
impl<'a> SupplierProfileCommandRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierProfileCommand> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierProfileCommand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierProfileCommand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierProfileCommand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierProfileCommand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierProfileCommand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::supplier::SupplierProfileCommand>>
    where
