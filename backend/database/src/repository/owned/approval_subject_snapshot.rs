//! Owned MongoDB repository for [`entities::approval_integration::ApprovalSubjectSnapshot`].
...
pub struct ApprovalSubjectSnapshotRepository<'a> {
    inner: persistence_core::Repository<'a, entities::approval_integration::ApprovalSubjectSnapshot>,
}
...
impl<'a> ApprovalSubjectSnapshotRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::approval_integration::ApprovalSubjectSnapshot> {
    ...
    pub async fn create(
        &self,
        entity: &entities::approval_integration::ApprovalSubjectSnapshot,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::approval_integration::ApprovalSubjectSnapshot>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::approval_integration::ApprovalSubjectSnapshot,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::approval_integration::ApprovalSubjectSnapshot: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::approval_integration::ApprovalSubjectSnapshot>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::approval_integration::ApprovalSubjectSnapshot>,
    >
    where
