//! Owned MongoDB repository for [`entities::supplier_settlement::SupplierSettlementDifferenceEvidence`].

/// Owned repository for `SupplierSettlementDifferenceEvidence`.
///
...
pub struct SupplierSettlementDifferenceEvidenceRepository<'a> {
    inner:
        persistence_core::Repository<'a, entities::supplier_settlement::SupplierSettlementDifferenceEvidence>,
}

impl<'a> SupplierSettlementDifferenceEvidenceRepository<'a> {
    /// Creates a `SupplierSettlementDifferenceEvidence` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierSettlementDifferenceEvidence`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierSettlementDifferenceEvidence`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::supplier_settlement::SupplierSettlementDifferenceEvidence> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_settlement::SupplierSettlementDifferenceEvidence,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_settlement::SupplierSettlementDifferenceEvidence>>
    {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_settlement::SupplierSettlementDifferenceEvidence,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_settlement::SupplierSettlementDifferenceEvidence: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_settlement::SupplierSettlementDifferenceEvidence>>
    {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_settlement::SupplierSettlementDifferenceEvidence>,
    >
    where
