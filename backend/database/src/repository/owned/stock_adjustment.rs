//! Owned MongoDB repository for [`entities::inventory::StockAdjustment`].
...
pub struct StockAdjustmentRepository<'a> {
    inner: persistence_core::Repository<'a, entities::inventory::StockAdjustment>,
}
...
impl<'a> StockAdjustmentRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::inventory::StockAdjustment> {
    ...
    pub async fn create(
        &self,
        entity: &entities::inventory::StockAdjustment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::inventory::StockAdjustment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::inventory::StockAdjustment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::inventory::StockAdjustment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::inventory::StockAdjustment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::inventory::StockAdjustment>>
    where
