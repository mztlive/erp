//! Owned MongoDB repository for [`entities::warehouse::WarehouseSkuPolicy`].
...
pub struct WarehouseSkuPolicyRepository<'a> {
    inner: persistence_core::Repository<'a, entities::warehouse::WarehouseSkuPolicy>,
}
...
impl<'a> WarehouseSkuPolicyRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::warehouse::WarehouseSkuPolicy> {
    ...
    pub async fn create(
        &self,
        entity: &entities::warehouse::WarehouseSkuPolicy,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::warehouse::WarehouseSkuPolicy>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::warehouse::WarehouseSkuPolicy,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::warehouse::WarehouseSkuPolicy: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::warehouse::WarehouseSkuPolicy>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::warehouse::WarehouseSkuPolicy>>
    where
