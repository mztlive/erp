//! Owned MongoDB repository for [`entities::catalog::ProductRevision`].
...
pub struct ProductRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::ProductRevision>,
}
...
impl<'a> ProductRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::ProductRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::ProductRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::ProductRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::ProductRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::ProductRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::ProductRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::ProductRevision>>
    where
