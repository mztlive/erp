//! Owned MongoDB repository for [`entities::Role`].
...
pub struct RoleRepository<'a> {
    inner: persistence_core::Repository<'a, entities::Role>,
}
...
impl<'a> RoleRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::Role> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::Role>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::Role,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::Role: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::Role>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::Role>>
    where
