//! Owned MongoDB repository for [`entities::returns::ReceiptReversal`].
...
pub struct ReceiptReversalRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::ReceiptReversal>,
}
...
impl<'a> ReceiptReversalRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::ReceiptReversal> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::ReceiptReversal,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::ReceiptReversal>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::ReceiptReversal,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::ReceiptReversal: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::ReceiptReversal>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::ReceiptReversal>>
    where
