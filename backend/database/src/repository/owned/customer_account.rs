//! Owned MongoDB repository for [`entities::customer::CustomerAccount`].
...
pub struct CustomerAccountRepository<'a> {
    inner: persistence_core::Repository<'a, entities::customer::CustomerAccount>,
}
...
impl<'a> CustomerAccountRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::customer::CustomerAccount> {
    ...
    pub async fn create(
        &self,
        entity: &entities::customer::CustomerAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::customer::CustomerAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::customer::CustomerAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::customer::CustomerAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::customer::CustomerAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::customer::CustomerAccount>>
    where
