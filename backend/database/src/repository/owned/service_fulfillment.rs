//! Owned MongoDB repository for [`entities::fulfillment::ServiceFulfillment`].
...
pub struct ServiceFulfillmentRepository<'a> {
    inner: persistence_core::Repository<'a, entities::fulfillment::ServiceFulfillment>,
}
...
impl<'a> ServiceFulfillmentRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::fulfillment::ServiceFulfillment> {
    ...
    pub async fn create(
        &self,
        entity: &entities::fulfillment::ServiceFulfillment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::fulfillment::ServiceFulfillment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::fulfillment::ServiceFulfillment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::fulfillment::ServiceFulfillment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::fulfillment::ServiceFulfillment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::fulfillment::ServiceFulfillment>>
    where
