//! Owned MongoDB repository for [`entities::procurement_responsibility::ProcurementResponsibilityRule`].
...
pub struct ProcurementResponsibilityRuleRepository<'a> {
    inner:
        persistence_core::Repository<'a, entities::procurement_responsibility::ProcurementResponsibilityRule>,
}
...
impl<'a> ProcurementResponsibilityRuleRepository<'a> {
    ...
    /// Returns the MongoDB collection handle for `ProcurementResponsibilityRule`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::procurement_responsibility::ProcurementResponsibilityRule> {
    ...
    pub async fn create(
        &self,
        entity: &entities::procurement_responsibility::ProcurementResponsibilityRule,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::procurement_responsibility::ProcurementResponsibilityRule>>
    {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::procurement_responsibility::ProcurementResponsibilityRule,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::procurement_responsibility::ProcurementResponsibilityRule: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::procurement_responsibility::ProcurementResponsibilityRule>>
    {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::procurement_responsibility::ProcurementResponsibilityRule>,
    >
    where
