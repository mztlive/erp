//! Owned MongoDB repository for [`entities::receivable::ReceivableEntry`].
...
pub struct ReceivableEntryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::ReceivableEntry>,
}
...
impl<'a> ReceivableEntryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::ReceivableEntry> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::ReceivableEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::ReceivableEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::ReceivableEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::ReceivableEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::ReceivableEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::ReceivableEntry>>
    where
