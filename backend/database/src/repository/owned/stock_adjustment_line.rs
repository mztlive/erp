//! Owned MongoDB repository for [`entities::inventory::StockAdjustmentLine`].
...
pub struct StockAdjustmentLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::inventory::StockAdjustmentLine>,
}
...
impl<'a> StockAdjustmentLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::inventory::StockAdjustmentLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::inventory::StockAdjustmentLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::inventory::StockAdjustmentLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::inventory::StockAdjustmentLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::inventory::StockAdjustmentLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::inventory::StockAdjustmentLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::inventory::StockAdjustmentLine>>
    where
