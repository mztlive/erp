//! Owned MongoDB repository for [`entities::fulfillment::CustomerAcceptance`].
...
pub struct CustomerAcceptanceRepository<'a> {
    inner: persistence_core::Repository<'a, entities::fulfillment::CustomerAcceptance>,
}
...
impl<'a> CustomerAcceptanceRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::fulfillment::CustomerAcceptance> {
    ...
    pub async fn create(
        &self,
        entity: &entities::fulfillment::CustomerAcceptance,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::fulfillment::CustomerAcceptance>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::fulfillment::CustomerAcceptance,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::fulfillment::CustomerAcceptance: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::fulfillment::CustomerAcceptance>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::fulfillment::CustomerAcceptance>>
    where
