//! Owned MongoDB repository for [`entities::cost::CostAllocation`].
...
pub struct CostAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::cost::CostAllocation>,
}
...
impl<'a> CostAllocationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::cost::CostAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::cost::CostAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::cost::CostAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::cost::CostAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::cost::CostAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::cost::CostAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::cost::CostAllocation>>
    where
