//! Owned MongoDB repository for [`entities::payable::SupplierPayment`].
...
pub struct SupplierPaymentRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::SupplierPayment>,
}
...
impl<'a> SupplierPaymentRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::SupplierPayment> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::SupplierPayment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::SupplierPayment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::SupplierPayment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::SupplierPayment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::SupplierPayment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::SupplierPayment>>
    where
