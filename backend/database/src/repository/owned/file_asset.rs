//! Owned MongoDB repository for [`entities::file_asset::FileAsset`].
...
pub struct FileAssetRepository<'a> {
    inner: persistence_core::Repository<'a, entities::file_asset::FileAsset>,
}
...
impl<'a> FileAssetRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::file_asset::FileAsset> {
    ...
    pub async fn create(
        &self,
        entity: &entities::file_asset::FileAsset,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::file_asset::FileAsset>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::file_asset::FileAsset,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::file_asset::FileAsset: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::file_asset::FileAsset>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::file_asset::FileAsset>>
    where
