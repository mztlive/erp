//! Owned MongoDB repository for [`entities::sales_order::SalesOrderLine`].
...
pub struct SalesOrderLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::sales_order::SalesOrderLine>,
}
...
impl<'a> SalesOrderLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::sales_order::SalesOrderLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::sales_order::SalesOrderLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::sales_order::SalesOrderLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::sales_order::SalesOrderLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::sales_order::SalesOrderLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::sales_order::SalesOrderLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::sales_order::SalesOrderLine>>
    where
