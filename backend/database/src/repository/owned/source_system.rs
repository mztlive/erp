//! Owned MongoDB repository for [`entities::source_registry::SourceSystem`].
...
pub struct SourceSystemRepository<'a> {
    inner: persistence_core::Repository<'a, entities::source_registry::SourceSystem>,
}
...
impl<'a> SourceSystemRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::source_registry::SourceSystem> {
    ...
    pub async fn create(
        &self,
        entity: &entities::source_registry::SourceSystem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::source_registry::SourceSystem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::source_registry::SourceSystem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::source_registry::SourceSystem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::source_registry::SourceSystem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::source_registry::SourceSystem>>
    where
