//! Owned MongoDB repository for [`entities::work_item::WorkItem`].
...
pub struct WorkItemRepository<'a> {
    inner: persistence_core::Repository<'a, entities::work_item::WorkItem>,
}
...
impl<'a> WorkItemRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::work_item::WorkItem> {
    ...
    pub async fn create(
        &self,
        entity: &entities::work_item::WorkItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::work_item::WorkItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::work_item::WorkItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::work_item::WorkItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::work_item::WorkItem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::work_item::WorkItem>>
    where
