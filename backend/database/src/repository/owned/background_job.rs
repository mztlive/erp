//! Owned MongoDB repository for [`entities::bulk_job::BackgroundJob`].
...
pub struct BackgroundJobRepository<'a> {
    inner: persistence_core::Repository<'a, entities::bulk_job::BackgroundJob>,
}
...
impl<'a> BackgroundJobRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::bulk_job::BackgroundJob> {
    ...
    pub async fn create(
        &self,
        entity: &entities::bulk_job::BackgroundJob,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::bulk_job::BackgroundJob>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::bulk_job::BackgroundJob,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::bulk_job::BackgroundJob: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::bulk_job::BackgroundJob>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::bulk_job::BackgroundJob>>
    where
