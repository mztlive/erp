//! Owned MongoDB repository for [`entities::bulk_job::BulkSelectionSnapshot`].
...
pub struct BulkSelectionSnapshotRepository<'a> {
    inner: persistence_core::Repository<'a, entities::bulk_job::BulkSelectionSnapshot>,
}
...
impl<'a> BulkSelectionSnapshotRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::bulk_job::BulkSelectionSnapshot> {
    ...
    pub async fn create(
        &self,
        entity: &entities::bulk_job::BulkSelectionSnapshot,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::bulk_job::BulkSelectionSnapshot>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::bulk_job::BulkSelectionSnapshot,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::bulk_job::BulkSelectionSnapshot: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::bulk_job::BulkSelectionSnapshot>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::bulk_job::BulkSelectionSnapshot>>
    where
