//! Owned MongoDB repository for [`entities::AccountCore`].
...
pub struct AccountCoreRepository<'a> {
    inner: persistence_core::Repository<'a, entities::AccountCore>,
}
...
impl<'a> AccountCoreRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::AccountCore> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::AccountCore>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::AccountCore,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::AccountCore: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::AccountCore>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::AccountCore>>
    where
