//! Owned MongoDB repository for [`entities::inventory::StockMovement`].
...
pub struct StockMovementRepository<'a> {
    inner: persistence_core::Repository<'a, entities::inventory::StockMovement>,
}
...
impl<'a> StockMovementRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::inventory::StockMovement> {
    ...
    pub async fn create(
        &self,
        entity: &entities::inventory::StockMovement,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::inventory::StockMovement>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::inventory::StockMovement,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::inventory::StockMovement: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::inventory::StockMovement>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::inventory::StockMovement>>
    where
