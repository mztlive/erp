//! Owned MongoDB repository for [`entities::catalog::UnitOfMeasure`].
...
pub struct UnitOfMeasureRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::UnitOfMeasure>,
}
...
impl<'a> UnitOfMeasureRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::UnitOfMeasure> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::UnitOfMeasure,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::UnitOfMeasure>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::UnitOfMeasure,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::UnitOfMeasure: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::UnitOfMeasure>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::UnitOfMeasure>>
    where
