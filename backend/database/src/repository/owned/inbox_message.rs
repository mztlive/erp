//! Owned MongoDB repository for [`entities::integration_ops::InboxMessage`].
...
pub struct InboxMessageRepository<'a> {
    inner: persistence_core::Repository<'a, entities::integration_ops::InboxMessage>,
}
...
impl<'a> InboxMessageRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::integration_ops::InboxMessage> {
    ...
    pub async fn create(
        &self,
        entity: &entities::integration_ops::InboxMessage,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::integration_ops::InboxMessage>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::integration_ops::InboxMessage,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::integration_ops::InboxMessage: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::integration_ops::InboxMessage>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::integration_ops::InboxMessage>>
    where
