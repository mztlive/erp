//! Owned MongoDB repository for [`entities::catalog::Sku`].
...
pub struct SkuRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::Sku>,
}
...
impl<'a> SkuRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::Sku> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::Sku>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::Sku,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::Sku: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::Sku>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::Sku>>
    where
