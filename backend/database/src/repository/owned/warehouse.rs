//! Owned MongoDB repository for [`entities::warehouse::Warehouse`].
...
pub struct WarehouseRepository<'a> {
    inner: persistence_core::Repository<'a, entities::warehouse::Warehouse>,
}
...
impl<'a> WarehouseRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::warehouse::Warehouse> {
    ...
    pub async fn create(
        &self,
        entity: &entities::warehouse::Warehouse,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::warehouse::Warehouse>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::warehouse::Warehouse,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::warehouse::Warehouse: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::warehouse::Warehouse>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::warehouse::Warehouse>>
    where
