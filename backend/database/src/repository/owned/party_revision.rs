//! Owned MongoDB repository for [`entities::party::PartyRevision`].
...
pub struct PartyRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::PartyRevision>,
}
...
impl<'a> PartyRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::PartyRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::party::PartyRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::PartyRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::PartyRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::PartyRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::PartyRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::PartyRevision>>
    where
