//! Owned MongoDB repository for [`entities::supplier_api::BusinessCapabilityConfirmation`].
...
pub struct BusinessCapabilityConfirmationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_api::BusinessCapabilityConfirmation>,
}
...
impl<'a> BusinessCapabilityConfirmationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_api::BusinessCapabilityConfirmation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_api::BusinessCapabilityConfirmation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_api::BusinessCapabilityConfirmation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_api::BusinessCapabilityConfirmation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_api::BusinessCapabilityConfirmation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_api::BusinessCapabilityConfirmation>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_api::BusinessCapabilityConfirmation>,
    >
    where
