//! Owned MongoDB repository for [`entities::returns::SalesReturnLine`].
...
pub struct SalesReturnLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::SalesReturnLine>,
}
...
impl<'a> SalesReturnLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::SalesReturnLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::SalesReturnLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::SalesReturnLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::SalesReturnLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::SalesReturnLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::SalesReturnLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::SalesReturnLine>>
    where
