//! Owned MongoDB repository for [`entities::customer::CustomerProfileCommand`].

/// Owned repository for `CustomerProfileCommand`.
///
...
pub struct CustomerProfileCommandRepository<'a> {
    inner: persistence_core::Repository<'a, entities::customer::CustomerProfileCommand>,
}

impl<'a> CustomerProfileCommandRepository<'a> {
    /// Creates a `CustomerProfileCommand` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CustomerProfileCommand`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CustomerProfileCommand`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::customer::CustomerProfileCommand> {
    ...
    pub async fn create(
        &self,
        entity: &entities::customer::CustomerProfileCommand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::customer::CustomerProfileCommand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::customer::CustomerProfileCommand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::customer::CustomerProfileCommand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::customer::CustomerProfileCommand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::customer::CustomerProfileCommand>>
    where
