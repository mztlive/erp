//! Owned MongoDB repository for [`entities::receivable::CustomerReceipt`].
...
pub struct CustomerReceiptRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::CustomerReceipt>,
}
...
impl<'a> CustomerReceiptRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::CustomerReceipt> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::CustomerReceipt,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::CustomerReceipt>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::CustomerReceipt,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::CustomerReceipt: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::CustomerReceipt>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::CustomerReceipt>>
    where
