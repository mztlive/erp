//! Owned MongoDB repository for [`entities::bulk_job::BackgroundJobItem`].

/// Owned repository for `BackgroundJobItem`.
///
...
pub struct BackgroundJobItemRepository<'a> {
    inner: persistence_core::Repository<'a, entities::bulk_job::BackgroundJobItem>,
}

impl<'a> BackgroundJobItemRepository<'a> {
    /// Creates a `BackgroundJobItem` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `BackgroundJobItem`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `BackgroundJobItem`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::bulk_job::BackgroundJobItem> {
    ...
    pub async fn create(
        &self,
        entity: &entities::bulk_job::BackgroundJobItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::bulk_job::BackgroundJobItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::bulk_job::BackgroundJobItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::bulk_job::BackgroundJobItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::bulk_job::BackgroundJobItem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::bulk_job::BackgroundJobItem>>
    where
