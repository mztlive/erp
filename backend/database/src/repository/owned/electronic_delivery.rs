//! Owned MongoDB repository for [`entities::fulfillment::ElectronicDelivery`].
...
pub struct ElectronicDeliveryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::fulfillment::ElectronicDelivery>,
}
...
impl<'a> ElectronicDeliveryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::fulfillment::ElectronicDelivery> {
    ...
    pub async fn create(
        &self,
        entity: &entities::fulfillment::ElectronicDelivery,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::fulfillment::ElectronicDelivery>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::fulfillment::ElectronicDelivery,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::fulfillment::ElectronicDelivery: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::fulfillment::ElectronicDelivery>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::fulfillment::ElectronicDelivery>>
    where
