//! Owned MongoDB repository for [`entities::returns::PaymentReversal`].
...
pub struct PaymentReversalRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::PaymentReversal>,
}
...
impl<'a> PaymentReversalRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::PaymentReversal> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::PaymentReversal,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::PaymentReversal>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::PaymentReversal,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::PaymentReversal: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::PaymentReversal>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::PaymentReversal>>
    where
