//! Owned MongoDB repository for [`entities::fulfillment::Delivery`].
...
pub struct DeliveryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::fulfillment::Delivery>,
}
...
impl<'a> DeliveryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::fulfillment::Delivery> {
    ...
    pub async fn create(
        &self,
        entity: &entities::fulfillment::Delivery,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::fulfillment::Delivery>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::fulfillment::Delivery,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::fulfillment::Delivery: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::fulfillment::Delivery>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::fulfillment::Delivery>>
    where
