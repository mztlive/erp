//! Owned MongoDB repository for [`entities::integration_ops::ReconciliationDifferenceResolution`].

/// Owned repository for `ReconciliationDifferenceResolution`.
///
...
pub struct ReconciliationDifferenceResolutionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::integration_ops::ReconciliationDifferenceResolution>,
}

impl<'a> ReconciliationDifferenceResolutionRepository<'a> {
    /// Creates a `ReconciliationDifferenceResolution` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReconciliationDifferenceResolution`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReconciliationDifferenceResolution`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::integration_ops::ReconciliationDifferenceResolution> {
    ...
    pub async fn create(
        &self,
        entity: &entities::integration_ops::ReconciliationDifferenceResolution,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::integration_ops::ReconciliationDifferenceResolution>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::integration_ops::ReconciliationDifferenceResolution,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::integration_ops::ReconciliationDifferenceResolution: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::integration_ops::ReconciliationDifferenceResolution>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::integration_ops::ReconciliationDifferenceResolution>,
    >
    where
