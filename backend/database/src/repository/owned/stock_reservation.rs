//! Owned MongoDB repository for [`entities::inventory::StockReservation`].
...
pub struct StockReservationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::inventory::StockReservation>,
}
...
impl<'a> StockReservationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::inventory::StockReservation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::inventory::StockReservation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::inventory::StockReservation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::inventory::StockReservation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::inventory::StockReservation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::inventory::StockReservation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::inventory::StockReservation>>
    where
