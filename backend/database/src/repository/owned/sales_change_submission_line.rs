//! Owned MongoDB repository for [`entities::sales_review::SalesChangeSubmissionLine`].
...
pub struct SalesChangeSubmissionLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::sales_review::SalesChangeSubmissionLine>,
}
...
impl<'a> SalesChangeSubmissionLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::sales_review::SalesChangeSubmissionLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::sales_review::SalesChangeSubmissionLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::sales_review::SalesChangeSubmissionLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::sales_review::SalesChangeSubmissionLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::sales_review::SalesChangeSubmissionLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::sales_review::SalesChangeSubmissionLine>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::sales_review::SalesChangeSubmissionLine>,
    >
    where
