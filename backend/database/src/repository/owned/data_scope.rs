//! Owned MongoDB repository for [`entities::access_control::DataScope`].
...
pub struct DataScopeRepository<'a> {
    inner: persistence_core::Repository<'a, entities::access_control::DataScope>,
}
...
impl<'a> DataScopeRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::access_control::DataScope> {
    ...
    pub async fn create(
        &self,
        entity: &entities::access_control::DataScope,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::access_control::DataScope>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::access_control::DataScope,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::access_control::DataScope: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::access_control::DataScope>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::access_control::DataScope>>
    where
