//! Owned MongoDB repository for [`entities::catalog::ProductBrand`].
...
pub struct ProductBrandRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::ProductBrand>,
}
...
impl<'a> ProductBrandRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::ProductBrand> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::ProductBrand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::ProductBrand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::ProductBrand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::ProductBrand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::ProductBrand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::ProductBrand>>
    where
