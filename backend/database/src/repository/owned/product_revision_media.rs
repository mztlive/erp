//! Owned MongoDB repository for [`entities::catalog::ProductRevisionMedia`].
...
pub struct ProductRevisionMediaRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::ProductRevisionMedia>,
}
...
impl<'a> ProductRevisionMediaRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::ProductRevisionMedia> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::ProductRevisionMedia,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::ProductRevisionMedia>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::ProductRevisionMedia,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::ProductRevisionMedia: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::ProductRevisionMedia>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::ProductRevisionMedia>>
    where
