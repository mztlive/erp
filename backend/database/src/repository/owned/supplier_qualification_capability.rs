//! Owned MongoDB repository for [`entities::supplier::SupplierQualificationCapability`].
...
pub struct SupplierQualificationCapabilityRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierQualificationCapability>,
}
...
impl<'a> SupplierQualificationCapabilityRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierQualificationCapability> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierQualificationCapability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierQualificationCapability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierQualificationCapability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierQualificationCapability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierQualificationCapability>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier::SupplierQualificationCapability>,
    >
    where
