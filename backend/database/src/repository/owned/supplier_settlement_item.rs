//! Owned MongoDB repository for [`entities::supplier_settlement::SupplierSettlementItem`].
...
pub struct SupplierSettlementItemRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_settlement::SupplierSettlementItem>,
}
...
impl<'a> SupplierSettlementItemRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_settlement::SupplierSettlementItem> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_settlement::SupplierSettlementItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_settlement::SupplierSettlementItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_settlement::SupplierSettlementItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_settlement::SupplierSettlementItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_settlement::SupplierSettlementItem>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_settlement::SupplierSettlementItem>,
    >
    where
