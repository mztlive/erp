//! Owned MongoDB repository for [`entities::legacy_import::LegacyImportBatch`].
...
pub struct LegacyImportBatchRepository<'a> {
    inner: persistence_core::Repository<'a, entities::legacy_import::LegacyImportBatch>,
}
...
impl<'a> LegacyImportBatchRepository<'a> {
    ...
    /// Returns the MongoDB collection handle for `LegacyImportBatch`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::legacy_import::LegacyImportBatch> {
    ...
    pub async fn create(
        &self,
        entity: &entities::legacy_import::LegacyImportBatch,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::legacy_import::LegacyImportBatch>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::legacy_import::LegacyImportBatch,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::legacy_import::LegacyImportBatch: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::legacy_import::LegacyImportBatch>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::legacy_import::LegacyImportBatch>>
    where
