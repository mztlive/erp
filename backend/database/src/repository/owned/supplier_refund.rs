//! Owned MongoDB repository for [`entities::returns::SupplierRefund`].
...
pub struct SupplierRefundRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::SupplierRefund>,
}
...
impl<'a> SupplierRefundRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::SupplierRefund> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::SupplierRefund,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::SupplierRefund>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::SupplierRefund,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::SupplierRefund: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::SupplierRefund>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::SupplierRefund>>
    where
