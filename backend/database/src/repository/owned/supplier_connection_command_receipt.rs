//! Owned MongoDB repository for [`entities::supplier_api::SupplierConnectionCommandReceipt`].
...
pub struct SupplierConnectionCommandReceiptRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_api::SupplierConnectionCommandReceipt>,
}
...
impl<'a> SupplierConnectionCommandReceiptRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<entities::supplier_api::SupplierConnectionCommandReceipt> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_api::SupplierConnectionCommandReceipt,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_api::SupplierConnectionCommandReceipt>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_api::SupplierConnectionCommandReceipt,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_api::SupplierConnectionCommandReceipt: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_api::SupplierConnectionCommandReceipt>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_api::SupplierConnectionCommandReceipt>,
    >
    where
