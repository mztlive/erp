//! Owned MongoDB repository for [`entities::catalog::ProductCategory`].
...
pub struct ProductCategoryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::ProductCategory>,
}
...
impl<'a> ProductCategoryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::ProductCategory> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::ProductCategory,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::ProductCategory>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::ProductCategory,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::ProductCategory: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::ProductCategory>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::ProductCategory>>
    where
