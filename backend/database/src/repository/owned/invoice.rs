//! Owned MongoDB repository for [`entities::receivable::Invoice`].
...
pub struct InvoiceRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::Invoice>,
}
...
impl<'a> InvoiceRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::Invoice> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::Invoice,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::Invoice>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::Invoice,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::Invoice: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::Invoice>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::Invoice>>
    where
