//! Owned MongoDB repository for [`entities::inventory::StockBalance`].
...
pub struct StockBalanceRepository<'a> {
    inner: persistence_core::Repository<'a, entities::inventory::StockBalance>,
}
...
impl<'a> StockBalanceRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::inventory::StockBalance> {
    ...
    pub async fn create(
        &self,
        entity: &entities::inventory::StockBalance,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::inventory::StockBalance>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::inventory::StockBalance,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::inventory::StockBalance: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::inventory::StockBalance>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::inventory::StockBalance>>
    where
