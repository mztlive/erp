//! Owned MongoDB repository for [`entities::receivable::SalesInvoiceAllocation`].
...
pub struct SalesInvoiceAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::receivable::SalesInvoiceAllocation>,
}
...
impl<'a> SalesInvoiceAllocationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::receivable::SalesInvoiceAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::receivable::SalesInvoiceAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::receivable::SalesInvoiceAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::receivable::SalesInvoiceAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::receivable::SalesInvoiceAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::receivable::SalesInvoiceAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::receivable::SalesInvoiceAllocation>>
    where
