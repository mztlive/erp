//! Owned MongoDB repository for [`entities::AuditLog`].
...
pub struct AuditLogRepository<'a> {
    inner: persistence_core::Repository<'a, entities::AuditLog>,
}
...
impl<'a> AuditLogRepository<'a> {
    ...
    /// Returns the MongoDB collection handle for `AuditLog`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::AuditLog> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::AuditLog>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::AuditLog,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::AuditLog: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::AuditLog>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::AuditLog>>
    where
