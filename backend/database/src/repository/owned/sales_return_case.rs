//! Owned MongoDB repository for [`entities::returns::SalesReturnCase`].
...
pub struct SalesReturnCaseRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::SalesReturnCase>,
}
...
impl<'a> SalesReturnCaseRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::SalesReturnCase> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::SalesReturnCase,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::SalesReturnCase>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::SalesReturnCase,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::SalesReturnCase: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::SalesReturnCase>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::SalesReturnCase>>
    where
