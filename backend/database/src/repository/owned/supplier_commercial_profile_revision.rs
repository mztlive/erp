//! Owned MongoDB repository for [`entities::supplier::SupplierCommercialProfileRevision`].
...
pub struct SupplierCommercialProfileRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier::SupplierCommercialProfileRevision>,
}
...
impl<'a> SupplierCommercialProfileRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier::SupplierCommercialProfileRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier::SupplierCommercialProfileRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier::SupplierCommercialProfileRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier::SupplierCommercialProfileRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier::SupplierCommercialProfileRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier::SupplierCommercialProfileRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier::SupplierCommercialProfileRevision>,
    >
    where
