//! Owned MongoDB repository for [`entities::catalog::VoucherCategoryProfileRevision`].
...
pub struct VoucherCategoryProfileRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::VoucherCategoryProfileRevision>,
}
...
impl<'a> VoucherCategoryProfileRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::VoucherCategoryProfileRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::VoucherCategoryProfileRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::VoucherCategoryProfileRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::VoucherCategoryProfileRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::VoucherCategoryProfileRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::VoucherCategoryProfileRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::catalog::VoucherCategoryProfileRevision>,
    >
    where
