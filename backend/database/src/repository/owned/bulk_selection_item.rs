//! Owned MongoDB repository for [`entities::bulk_job::BulkSelectionItem`].
...
pub struct BulkSelectionItemRepository<'a> {
    inner: persistence_core::Repository<'a, entities::bulk_job::BulkSelectionItem>,
}
...
impl<'a> BulkSelectionItemRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::bulk_job::BulkSelectionItem> {
    ...
    pub async fn create(
        &self,
        entity: &entities::bulk_job::BulkSelectionItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::bulk_job::BulkSelectionItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::bulk_job::BulkSelectionItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::bulk_job::BulkSelectionItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::bulk_job::BulkSelectionItem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::bulk_job::BulkSelectionItem>>
    where
