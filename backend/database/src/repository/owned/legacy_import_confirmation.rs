//! Owned MongoDB repository for [`entities::legacy_import::LegacyImportConfirmation`].
...
pub struct LegacyImportConfirmationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::legacy_import::LegacyImportConfirmation>,
}
...
impl<'a> LegacyImportConfirmationRepository<'a> {
    ...
    /// Returns the MongoDB collection handle for `LegacyImportConfirmation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::legacy_import::LegacyImportConfirmation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::legacy_import::LegacyImportConfirmation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::legacy_import::LegacyImportConfirmation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::legacy_import::LegacyImportConfirmation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::legacy_import::LegacyImportConfirmation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::legacy_import::LegacyImportConfirmation>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::legacy_import::LegacyImportConfirmation>,
    >
    where
