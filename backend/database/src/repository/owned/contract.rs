//! Owned MongoDB repository for [`entities::contract::Contract`].
...
pub struct ContractRepository<'a> {
    inner: persistence_core::Repository<'a, entities::contract::Contract>,
}
...
impl<'a> ContractRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::contract::Contract> {
    ...
    pub async fn create(
        &self,
        entity: &entities::contract::Contract,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::contract::Contract>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::contract::Contract,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::contract::Contract: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::contract::Contract>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::contract::Contract>>
    where
