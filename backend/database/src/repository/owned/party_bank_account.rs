//! Owned MongoDB repository for [`entities::party::PartyBankAccount`].
...
pub struct PartyBankAccountRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::PartyBankAccount>,
}
...
impl<'a> PartyBankAccountRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::PartyBankAccount> {
    ...
    pub async fn create(
        &self,
        entity: &entities::party::PartyBankAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::PartyBankAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::PartyBankAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::PartyBankAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::PartyBankAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::PartyBankAccount>>
    where
