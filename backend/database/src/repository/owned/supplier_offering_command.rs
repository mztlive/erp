//! Owned MongoDB repository for [`entities::supplier_offering::SupplierOfferingCommand`].
...
pub struct SupplierOfferingCommandRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_offering::SupplierOfferingCommand>,
}
...
impl<'a> SupplierOfferingCommandRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_offering::SupplierOfferingCommand> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_offering::SupplierOfferingCommand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_offering::SupplierOfferingCommand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_offering::SupplierOfferingCommand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_offering::SupplierOfferingCommand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_offering::SupplierOfferingCommand>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_offering::SupplierOfferingCommand>,
    >
    where
