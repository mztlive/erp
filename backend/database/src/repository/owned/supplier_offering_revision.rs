//! Owned MongoDB repository for [`entities::supplier_offering::SupplierOfferingRevision`].
...
pub struct SupplierOfferingRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_offering::SupplierOfferingRevision>,
}
...
impl<'a> SupplierOfferingRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_offering::SupplierOfferingRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_offering::SupplierOfferingRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_offering::SupplierOfferingRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_offering::SupplierOfferingRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_offering::SupplierOfferingRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_offering::SupplierOfferingRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_offering::SupplierOfferingRevision>,
    >
    where
