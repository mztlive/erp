//! Owned MongoDB repository for [`entities::catalog::Product`].
...
pub struct ProductRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::Product>,
}
...
impl<'a> ProductRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::Product> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::Product,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::Product>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::Product,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::Product: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::Product>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::Product>>
    where
