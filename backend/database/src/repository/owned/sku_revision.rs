//! Owned MongoDB repository for [`entities::catalog::SkuRevision`].
...
pub struct SkuRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::catalog::SkuRevision>,
}
...
impl<'a> SkuRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::catalog::SkuRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::catalog::SkuRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::catalog::SkuRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::catalog::SkuRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::catalog::SkuRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::catalog::SkuRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::catalog::SkuRevision>>
    where
