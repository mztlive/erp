//! Owned MongoDB repository for [`entities::fulfillment::PurchaseReceipt`].

/// Owned repository for `PurchaseReceipt`.
///
...
pub struct PurchaseReceiptRepository<'a> {
    inner: persistence_core::Repository<'a, entities::fulfillment::PurchaseReceipt>,
}

impl<'a> PurchaseReceiptRepository<'a> {
    /// Creates a `PurchaseReceipt` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PurchaseReceipt`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PurchaseReceipt`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<entities::fulfillment::PurchaseReceipt> {
    ...
    pub async fn create(
        &self,
        entity: &entities::fulfillment::PurchaseReceipt,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::fulfillment::PurchaseReceipt>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::fulfillment::PurchaseReceipt,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::fulfillment::PurchaseReceipt: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::fulfillment::PurchaseReceipt>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::fulfillment::PurchaseReceipt>>
    where
