//! Owned MongoDB repository for [`entities::returns::PurchaseReturnLine`].
...
pub struct PurchaseReturnLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::returns::PurchaseReturnLine>,
}
...
impl<'a> PurchaseReturnLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::returns::PurchaseReturnLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::returns::PurchaseReturnLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::returns::PurchaseReturnLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::returns::PurchaseReturnLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::returns::PurchaseReturnLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::returns::PurchaseReturnLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::returns::PurchaseReturnLine>>
    where
