//! Owned MongoDB repository for [`entities::party::PartyAddress`].
...
pub struct PartyAddressRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::PartyAddress>,
}
...
impl<'a> PartyAddressRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::PartyAddress> {
    ...
    pub async fn create(
        &self,
        entity: &entities::party::PartyAddress,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::PartyAddress>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::PartyAddress,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::PartyAddress: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::PartyAddress>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::PartyAddress>>
    where
