//! Owned MongoDB repository for [`entities::file_asset::DocumentAttachment`].
...
pub struct DocumentAttachmentRepository<'a> {
    inner: persistence_core::Repository<'a, entities::file_asset::DocumentAttachment>,
}
...
impl<'a> DocumentAttachmentRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::file_asset::DocumentAttachment> {
    ...
    pub async fn create(
        &self,
        entity: &entities::file_asset::DocumentAttachment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::file_asset::DocumentAttachment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::file_asset::DocumentAttachment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::file_asset::DocumentAttachment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::file_asset::DocumentAttachment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::file_asset::DocumentAttachment>>
    where
