//! Owned MongoDB repository for [`entities::payable::PurchaseInvoiceAllocation`].
...
pub struct PurchaseInvoiceAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::PurchaseInvoiceAllocation>,
}
...
impl<'a> PurchaseInvoiceAllocationRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::PurchaseInvoiceAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::PurchaseInvoiceAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::PurchaseInvoiceAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::PurchaseInvoiceAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::PurchaseInvoiceAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::PurchaseInvoiceAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::PurchaseInvoiceAllocation>>
    where
