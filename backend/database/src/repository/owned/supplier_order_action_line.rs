//! Owned MongoDB repository for [`entities::supplier_fulfillment::SupplierOrderActionLine`].
...
pub struct SupplierOrderActionLineRepository<'a> {
    inner: persistence_core::Repository<'a, entities::supplier_fulfillment::SupplierOrderActionLine>,
}
...
impl<'a> SupplierOrderActionLineRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::supplier_fulfillment::SupplierOrderActionLine> {
    ...
    pub async fn create(
        &self,
        entity: &entities::supplier_fulfillment::SupplierOrderActionLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::supplier_fulfillment::SupplierOrderActionLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::supplier_fulfillment::SupplierOrderActionLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::supplier_fulfillment::SupplierOrderActionLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::supplier_fulfillment::SupplierOrderActionLine>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<entities::supplier_fulfillment::SupplierOrderActionLine>,
    >
    where
