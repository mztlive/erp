//! Owned MongoDB repository for [`entities::payable::PayableEntry`].
...
pub struct PayableEntryRepository<'a> {
    inner: persistence_core::Repository<'a, entities::payable::PayableEntry>,
}
...
impl<'a> PayableEntryRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::payable::PayableEntry> {
    ...
    pub async fn create(
        &self,
        entity: &entities::payable::PayableEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::payable::PayableEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::payable::PayableEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::payable::PayableEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::payable::PayableEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::payable::PayableEntry>>
    where
