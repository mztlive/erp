//! Owned MongoDB repository for [`entities::warehouse::WarehouseRevision`].
...
pub struct WarehouseRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, entities::warehouse::WarehouseRevision>,
}
...
impl<'a> WarehouseRevisionRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::warehouse::WarehouseRevision> {
    ...
    pub async fn create(
        &self,
        entity: &entities::warehouse::WarehouseRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::warehouse::WarehouseRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::warehouse::WarehouseRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::warehouse::WarehouseRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::warehouse::WarehouseRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::warehouse::WarehouseRevision>>
    where
