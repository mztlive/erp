//! Owned MongoDB repository for [`entities::party::PartyContact`].
...
pub struct PartyContactRepository<'a> {
    inner: persistence_core::Repository<'a, entities::party::PartyContact>,
}
...
impl<'a> PartyContactRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<entities::party::PartyContact> {
    ...
    pub async fn create(
        &self,
        entity: &entities::party::PartyContact,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<entities::party::PartyContact>> {
    ...
    pub async fn update(
        &self,
        entity: &mut entities::party::PartyContact,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        entities::party::PartyContact: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<entities::party::PartyContact>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<entities::party::PartyContact>>
    where
