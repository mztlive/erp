...
/// # 返回
/// 返回响应视图。
pub fn revision_line_to_view(
    line: &crate::entity::purchase_order::PurchaseOrderRevisionLine,
...
/// # 返回
/// 返回响应视图。
pub fn submission_line_to_view(
    line: &crate::entity::purchase_order::PurchaseOrderSubmissionLine,
) -> PurchaseOrderLineView {
    PurchaseOrderLineView {
        line_id: line.base.id.clone(),
        line_no: line.line_no,
