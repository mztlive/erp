...
impl<'a> PurchaseOrderRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::purchase_order::PurchaseOrder> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::purchase_order::PurchaseOrder,
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::purchase_order::PurchaseOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::purchase_order::PurchaseOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::purchase_order::PurchaseOrder>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::purchase_order::PurchaseOrder>>
    where
