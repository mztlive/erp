...
impl<'a> ProcurementResponsibilityRuleRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::procurement_responsibility::ProcurementResponsibilityRule> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::procurement_responsibility::ProcurementResponsibilityRule,
    ...
    pub async fn find_by_id(
        ...
        Option<crate::entity::procurement_responsibility::ProcurementResponsibilityRule>,
    > {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::procurement_responsibility::ProcurementResponsibilityRule,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::procurement_responsibility::ProcurementResponsibilityRule: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::procurement_responsibility::ProcurementResponsibilityRule>>
    {
