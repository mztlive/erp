...
impl<'a> PurchaseOrderSubmissionLineRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::purchase_order::PurchaseOrderSubmissionLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::purchase_order::PurchaseOrderSubmissionLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::purchase_order::PurchaseOrderSubmissionLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::purchase_order::PurchaseOrderSubmissionLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::purchase_order::PurchaseOrderSubmissionLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::purchase_order::PurchaseOrderSubmissionLine>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::purchase_order::PurchaseOrderSubmissionLine>,
    >
    where
