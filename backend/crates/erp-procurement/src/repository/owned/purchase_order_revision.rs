//! Owned MongoDB repository for [`crate::entity::purchase_order::PurchaseOrderRevision`].

/// Owned repository for `PurchaseOrderRevision`.
///
...
pub struct PurchaseOrderRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::purchase_order::PurchaseOrderRevision>,
}

impl<'a> PurchaseOrderRevisionRepository<'a> {
    /// Creates a `PurchaseOrderRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PurchaseOrderRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PurchaseOrderRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::purchase_order::PurchaseOrderRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::purchase_order::PurchaseOrderRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::purchase_order::PurchaseOrderRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::purchase_order::PurchaseOrderRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::purchase_order::PurchaseOrderRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::purchase_order::PurchaseOrderRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::purchase_order::PurchaseOrderRevision>,
    >
    where
