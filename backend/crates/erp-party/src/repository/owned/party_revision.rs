//! Owned MongoDB repository for [`crate::entity::party::PartyRevision`].

/// Owned repository for `PartyRevision`.
///
...
pub struct PartyRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::PartyRevision>,
}

impl<'a> PartyRevisionRepository<'a> {
    /// Creates a `PartyRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PartyRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PartyRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::PartyRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::PartyRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::PartyRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::PartyRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::PartyRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::PartyRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::PartyRevision>>
    where
