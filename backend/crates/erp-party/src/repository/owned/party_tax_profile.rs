//! Owned MongoDB repository for [`crate::entity::party::PartyTaxProfile`].

/// Owned repository for `PartyTaxProfile`.
///
...
pub struct PartyTaxProfileRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::PartyTaxProfile>,
}

impl<'a> PartyTaxProfileRepository<'a> {
    /// Creates a `PartyTaxProfile` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PartyTaxProfile`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PartyTaxProfile`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::PartyTaxProfile> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::PartyTaxProfile,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::PartyTaxProfile>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::PartyTaxProfile,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::PartyTaxProfile: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::PartyTaxProfile>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::PartyTaxProfile>>
    where
