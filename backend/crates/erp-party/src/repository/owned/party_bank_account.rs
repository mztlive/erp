//! Owned MongoDB repository for [`crate::entity::party::PartyBankAccount`].

/// Owned repository for `PartyBankAccount`.
///
...
pub struct PartyBankAccountRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::PartyBankAccount>,
}

impl<'a> PartyBankAccountRepository<'a> {
    /// Creates a `PartyBankAccount` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PartyBankAccount`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PartyBankAccount`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::PartyBankAccount> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::PartyBankAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::PartyBankAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::PartyBankAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::PartyBankAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::PartyBankAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::PartyBankAccount>>
    where
