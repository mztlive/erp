//! Owned MongoDB repository for [`crate::entity::party::PartyAddress`].

/// Owned repository for `PartyAddress`.
///
...
pub struct PartyAddressRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::PartyAddress>,
}

impl<'a> PartyAddressRepository<'a> {
    /// Creates a `PartyAddress` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PartyAddress`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PartyAddress`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::PartyAddress> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::PartyAddress,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::PartyAddress>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::PartyAddress,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::PartyAddress: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::PartyAddress>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::PartyAddress>>
    where
