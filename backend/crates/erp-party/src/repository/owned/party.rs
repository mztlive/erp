//! Owned MongoDB repository for [`crate::entity::party::Party`].

/// Owned repository for `Party`.
///
...
pub struct PartyRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::Party>,
}

impl<'a> PartyRepository<'a> {
    /// Creates a `Party` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Party`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Party`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::Party> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::Party,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::Party>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::Party,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::Party: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::Party>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::Party>>
    where
