//! Owned MongoDB repository for [`crate::entity::party::PartyContact`].

/// Owned repository for `PartyContact`.
///
...
pub struct PartyContactRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::party::PartyContact>,
}

impl<'a> PartyContactRepository<'a> {
    /// Creates a `PartyContact` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PartyContact`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PartyContact`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::party::PartyContact> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::party::PartyContact,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::party::PartyContact>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::party::PartyContact,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::party::PartyContact: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::party::PartyContact>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::party::PartyContact>>
    where
