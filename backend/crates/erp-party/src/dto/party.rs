...
impl From<crate::entity::party::PartyAddress> for PartyAddressView {
    /// 从实体构造响应视图。
    fn from(address: crate::entity::party::PartyAddress) -> Self {
        Self {
            id: address.base.id,
...
impl From<crate::entity::party::PartyTaxProfile> for PartyTaxProfileView {
    /// 从实体构造响应视图。
    fn from(profile: crate::entity::party::PartyTaxProfile) -> Self {
        Self {
            id: profile.base.id,
...
impl From<crate::entity::party::PartyBankAccount> for PartyBankAccountView {
    /// 从实体构造响应视图。
    fn from(account: crate::entity::party::PartyBankAccount) -> Self {
        Self {
            id: account.base.id,
