//! Owned MongoDB repository for [`crate::entity::integration_ops::InboxMessage`].

/// Owned repository for `InboxMessage`.
///
...
pub struct InboxMessageRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::integration_ops::InboxMessage>,
}

impl<'a> InboxMessageRepository<'a> {
    /// Creates a `InboxMessage` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `InboxMessage`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `InboxMessage`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::integration_ops::InboxMessage> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::integration_ops::InboxMessage,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::integration_ops::InboxMessage>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::integration_ops::InboxMessage,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::integration_ops::InboxMessage: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::integration_ops::InboxMessage>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::integration_ops::InboxMessage>>
    where
