//! Owned MongoDB repository for [`crate::entity::integration_ops::ReconciliationDifference`].

/// Owned repository for `ReconciliationDifference`.
///
...
pub struct ReconciliationDifferenceRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::integration_ops::ReconciliationDifference>,
}

impl<'a> ReconciliationDifferenceRepository<'a> {
    /// Creates a `ReconciliationDifference` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReconciliationDifference`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReconciliationDifference`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::integration_ops::ReconciliationDifference> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::integration_ops::ReconciliationDifference,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::integration_ops::ReconciliationDifference>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::integration_ops::ReconciliationDifference,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::integration_ops::ReconciliationDifference: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::integration_ops::ReconciliationDifference>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::integration_ops::ReconciliationDifference>,
    >
    where
