//! Owned MongoDB repository for [`crate::entity::integration_ops::ReconciliationDifferenceResolution`].
...
impl<'a> ReconciliationDifferenceResolutionRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::integration_ops::ReconciliationDifferenceResolution> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::integration_ops::ReconciliationDifferenceResolution,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::integration_ops::ReconciliationDifferenceResolution>>
    {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::integration_ops::ReconciliationDifferenceResolution,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::integration_ops::ReconciliationDifferenceResolution: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::integration_ops::ReconciliationDifferenceResolution>>
    {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::integration_ops::ReconciliationDifferenceResolution>,
    >
    where
