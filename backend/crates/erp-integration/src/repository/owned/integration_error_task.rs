//! Owned MongoDB repository for [`crate::entity::integration_ops::IntegrationErrorTask`].

/// Owned repository for `IntegrationErrorTask`.
///
...
pub struct IntegrationErrorTaskRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::integration_ops::IntegrationErrorTask>,
}

impl<'a> IntegrationErrorTaskRepository<'a> {
    /// Creates a `IntegrationErrorTask` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `IntegrationErrorTask`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `IntegrationErrorTask`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::integration_ops::IntegrationErrorTask> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::integration_ops::IntegrationErrorTask,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::integration_ops::IntegrationErrorTask>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::integration_ops::IntegrationErrorTask,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::integration_ops::IntegrationErrorTask: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::integration_ops::IntegrationErrorTask>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::integration_ops::IntegrationErrorTask>,
    >
    where
