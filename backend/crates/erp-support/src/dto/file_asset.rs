...
impl RegisterFileAssetRequest {
    ...
    /// # 错误
    /// 内容指纹形态非法时返回错误。
    pub fn into_data(self, created_by: &str) -> Result<FileAssetData> {
        Ok(FileAssetData {
...
pub struct AttachToDocumentRequest {
    ...
    pub document_id: erp_core::ids::BusinessDocumentId,
    /// 受控文件资产。
    pub file_asset_id: erp_core::ids::FileAssetId,
    /// 用途。
...
mod tests {
    ...
    fn register_request_converts_with_validated_hmac() {
        ...
        let bad = RegisterFileAssetRequest {
            ...
            sensitivity_class: crate::entity::file_asset::SensitivityClass::General,
            retention_class: crate::entity::file_asset::RetentionClass::LongTerm,
            expires_at: None,
        };
