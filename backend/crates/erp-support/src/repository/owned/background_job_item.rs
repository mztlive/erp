...
pub struct BackgroundJobItemRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::bulk_job::BackgroundJobItem>,
}
...
impl<'a> BackgroundJobItemRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::bulk_job::BackgroundJobItem> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::bulk_job::BackgroundJobItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::bulk_job::BackgroundJobItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::bulk_job::BackgroundJobItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::bulk_job::BackgroundJobItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::bulk_job::BackgroundJobItem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::bulk_job::BackgroundJobItem>>
    where
