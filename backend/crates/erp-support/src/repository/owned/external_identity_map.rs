//! Owned MongoDB repository for [`crate::entity::source_registry::ExternalIdentityMap`].

/// Owned repository for `ExternalIdentityMap`.
///
...
pub struct ExternalIdentityMapRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::source_registry::ExternalIdentityMap>,
}

impl<'a> ExternalIdentityMapRepository<'a> {
    /// Creates a `ExternalIdentityMap` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ExternalIdentityMap`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ExternalIdentityMap`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::source_registry::ExternalIdentityMap> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::source_registry::ExternalIdentityMap,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::source_registry::ExternalIdentityMap>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::source_registry::ExternalIdentityMap,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::source_registry::ExternalIdentityMap: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::source_registry::ExternalIdentityMap>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::source_registry::ExternalIdentityMap>,
    >
    where
