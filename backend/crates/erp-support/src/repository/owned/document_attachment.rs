//! Owned MongoDB repository for [`crate::entity::file_asset::DocumentAttachment`].

/// Owned repository for `DocumentAttachment`.
///
...
pub struct DocumentAttachmentRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::file_asset::DocumentAttachment>,
}

impl<'a> DocumentAttachmentRepository<'a> {
    /// Creates a `DocumentAttachment` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `DocumentAttachment`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `DocumentAttachment`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::file_asset::DocumentAttachment> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::file_asset::DocumentAttachment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::file_asset::DocumentAttachment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::file_asset::DocumentAttachment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::file_asset::DocumentAttachment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::file_asset::DocumentAttachment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::file_asset::DocumentAttachment>>
    where
