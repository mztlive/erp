//! Owned MongoDB repository for [`crate::entity::bulk_job::BackgroundJob`].

/// Owned repository for `BackgroundJob`.
///
...
pub struct BackgroundJobRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::bulk_job::BackgroundJob>,
}

impl<'a> BackgroundJobRepository<'a> {
    /// Creates a `BackgroundJob` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `BackgroundJob`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `BackgroundJob`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::bulk_job::BackgroundJob> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::bulk_job::BackgroundJob,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::bulk_job::BackgroundJob>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::bulk_job::BackgroundJob,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::bulk_job::BackgroundJob: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::bulk_job::BackgroundJob>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::bulk_job::BackgroundJob>>
    where
