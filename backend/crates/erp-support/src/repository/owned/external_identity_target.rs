//! Owned MongoDB repository for [`crate::entity::source_registry::ExternalIdentityTarget`].

/// Owned repository for `ExternalIdentityTarget`.
///
...
pub struct ExternalIdentityTargetRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::source_registry::ExternalIdentityTarget>,
}

impl<'a> ExternalIdentityTargetRepository<'a> {
    /// Creates a `ExternalIdentityTarget` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ExternalIdentityTarget`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ExternalIdentityTarget`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::source_registry::ExternalIdentityTarget> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::source_registry::ExternalIdentityTarget,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::source_registry::ExternalIdentityTarget>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::source_registry::ExternalIdentityTarget,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::source_registry::ExternalIdentityTarget: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::source_registry::ExternalIdentityTarget>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::source_registry::ExternalIdentityTarget>,
    >
    where
