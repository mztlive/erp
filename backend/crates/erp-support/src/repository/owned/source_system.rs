//! Owned MongoDB repository for [`crate::entity::source_registry::SourceSystem`].

/// Owned repository for `SourceSystem`.
///
...
pub struct SourceSystemRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::source_registry::SourceSystem>,
}

impl<'a> SourceSystemRepository<'a> {
    /// Creates a `SourceSystem` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SourceSystem`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SourceSystem`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::source_registry::SourceSystem> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::source_registry::SourceSystem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::source_registry::SourceSystem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::source_registry::SourceSystem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::source_registry::SourceSystem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::source_registry::SourceSystem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::source_registry::SourceSystem>>
    where
