//! Owned MongoDB repository for [`crate::entity::fulfillment::ElectronicDelivery`].

/// Owned repository for `ElectronicDelivery`.
///
...
pub struct ElectronicDeliveryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::fulfillment::ElectronicDelivery>,
}

impl<'a> ElectronicDeliveryRepository<'a> {
    /// Creates a `ElectronicDelivery` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ElectronicDelivery`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ElectronicDelivery`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::fulfillment::ElectronicDelivery> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::fulfillment::ElectronicDelivery,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::fulfillment::ElectronicDelivery>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::fulfillment::ElectronicDelivery,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::fulfillment::ElectronicDelivery: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::fulfillment::ElectronicDelivery>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::fulfillment::ElectronicDelivery>>
    where
