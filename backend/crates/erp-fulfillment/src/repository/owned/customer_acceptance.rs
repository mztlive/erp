//! Owned MongoDB repository for [`crate::entity::fulfillment::CustomerAcceptance`].

/// Owned repository for `CustomerAcceptance`.
///
...
pub struct CustomerAcceptanceRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::fulfillment::CustomerAcceptance>,
}

impl<'a> CustomerAcceptanceRepository<'a> {
    /// Creates a `CustomerAcceptance` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CustomerAcceptance`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CustomerAcceptance`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::fulfillment::CustomerAcceptance> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::fulfillment::CustomerAcceptance,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::fulfillment::CustomerAcceptance>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::fulfillment::CustomerAcceptance,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::fulfillment::CustomerAcceptance: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::fulfillment::CustomerAcceptance>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::fulfillment::CustomerAcceptance>>
    where
