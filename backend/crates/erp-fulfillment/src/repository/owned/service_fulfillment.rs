//! Owned MongoDB repository for [`crate::entity::fulfillment::ServiceFulfillment`].

/// Owned repository for `ServiceFulfillment`.
///
...
pub struct ServiceFulfillmentRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::fulfillment::ServiceFulfillment>,
}

impl<'a> ServiceFulfillmentRepository<'a> {
    /// Creates a `ServiceFulfillment` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ServiceFulfillment`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ServiceFulfillment`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::fulfillment::ServiceFulfillment> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::fulfillment::ServiceFulfillment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::fulfillment::ServiceFulfillment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::fulfillment::ServiceFulfillment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::fulfillment::ServiceFulfillment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::fulfillment::ServiceFulfillment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::fulfillment::ServiceFulfillment>>
    where
