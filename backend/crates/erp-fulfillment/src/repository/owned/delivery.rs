//! Owned MongoDB repository for [`crate::entity::fulfillment::Delivery`].

/// Owned repository for `Delivery`.
///
...
pub struct DeliveryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::fulfillment::Delivery>,
}

impl<'a> DeliveryRepository<'a> {
    /// Creates a `Delivery` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Delivery`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Delivery`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::fulfillment::Delivery> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::fulfillment::Delivery,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::fulfillment::Delivery>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::fulfillment::Delivery,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::fulfillment::Delivery: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::fulfillment::Delivery>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::fulfillment::Delivery>>
    where
