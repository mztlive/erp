...
pub struct PurchaseReceiptRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::fulfillment::PurchaseReceipt>,
}
...
impl<'a> PurchaseReceiptRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::fulfillment::PurchaseReceipt> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::fulfillment::PurchaseReceipt,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::fulfillment::PurchaseReceipt>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::fulfillment::PurchaseReceipt,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::fulfillment::PurchaseReceipt: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::fulfillment::PurchaseReceipt>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::fulfillment::PurchaseReceipt>>
    where
