...
use super::super::authority::purchase::previous_formal_submission_ids;
...
use super::super::change_order_brief::{LineStateMap, change_diff_lines};
use super::super::presentation::{format_yuan, purchase_review_impact_summary};
use super::super::{ObjectKind, WorkbenchObjectFact, WorkbenchObjectFactMap, WorkbenchSubjectDisplay};
use super::PurchaseReviewDisplay;
...
/// # 错误
/// 无。
pub(super) fn source_sales_orders_by_purchase_order(
...
/// # 错误
/// 无。
pub(super) fn assemble_purchase_review_displays(
...
fn split_purchase_brief_lines(lines: Vec<BriefLine>) -> (Vec<BriefLine>, u32) {
    ...
    let more_count = items.len().saturating_sub(super::super::brief::BRIEF_LINE_LIMIT) as u32;
    let mut visible = items;
    visible.truncate(super::super::brief::BRIEF_LINE_LIMIT);
    visible.extend(fees);
    (visible, more_count)
}
...
/// # 错误
/// 无。
pub(super) fn purchase_brief_lines(
    lines: impl IntoIterator<Item = PurchaseOrderSubmissionLine>,
) -> Vec<BriefLine> {
...
mod tests {
    ...
    use super::super::super::authority::purchase::previous_formal_submission_ids;
    use super::super::super::brief::format_business_due_label;
    use super::*;
