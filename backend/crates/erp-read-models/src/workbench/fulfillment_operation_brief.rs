...
async fn sales_order_numbers<A: erp_workflow::WorkflowAuthorizationPort>(
    service: &WorkbenchReadService<A>,
...
async fn purchase_order_numbers<A: erp_workflow::WorkflowAuthorizationPort>(
    service: &WorkbenchReadService<A>,
