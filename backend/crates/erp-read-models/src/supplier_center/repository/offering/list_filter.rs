...
mod tests {
    ...
    fn list_query_fields_preserve_all_filter_scopes() {
        ...
        let query = SupplierOfferingListQuery {
            availability_status: Some(erp_supply::entity::supplier_offering::AvailabilityStatus::Stale),
            ...
            status: Some(erp_supply::entity::supplier_offering::OfferingStatus::Paused),
            source_type: Some(erp_supply::entity::supplier_offering::OfferingSourceType::Api),
            page: 2,
            page_size: 15,
        ...
        assert_eq!(
            ...
            Some(erp_supply::entity::supplier_offering::AvailabilityStatus::Stale)
        );
