//! Owned MongoDB repository for [`crate::entity::warehouse::WarehouseSkuPolicy`].

/// Owned repository for `WarehouseSkuPolicy`.
///
...
pub struct WarehouseSkuPolicyRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::warehouse::WarehouseSkuPolicy>,
}

impl<'a> WarehouseSkuPolicyRepository<'a> {
    /// Creates a `WarehouseSkuPolicy` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `WarehouseSkuPolicy`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `WarehouseSkuPolicy`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::warehouse::WarehouseSkuPolicy> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::warehouse::WarehouseSkuPolicy,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::warehouse::WarehouseSkuPolicy>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::warehouse::WarehouseSkuPolicy,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::warehouse::WarehouseSkuPolicy: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::warehouse::WarehouseSkuPolicy>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::warehouse::WarehouseSkuPolicy>>
    where
