//! Owned MongoDB repository for [`crate::entity::warehouse::Warehouse`].

/// Owned repository for `Warehouse`.
///
...
pub struct WarehouseRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::warehouse::Warehouse>,
}

impl<'a> WarehouseRepository<'a> {
    /// Creates a `Warehouse` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Warehouse`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Warehouse`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::warehouse::Warehouse> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::warehouse::Warehouse,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::warehouse::Warehouse>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::warehouse::Warehouse,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::warehouse::Warehouse: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::warehouse::Warehouse>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::warehouse::Warehouse>>
    where
