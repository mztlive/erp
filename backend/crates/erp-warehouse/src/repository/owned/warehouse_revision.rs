//! Owned MongoDB repository for [`crate::entity::warehouse::WarehouseRevision`].

/// Owned repository for `WarehouseRevision`.
///
...
pub struct WarehouseRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::warehouse::WarehouseRevision>,
}

impl<'a> WarehouseRevisionRepository<'a> {
    /// Creates a `WarehouseRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `WarehouseRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `WarehouseRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::warehouse::WarehouseRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::warehouse::WarehouseRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::warehouse::WarehouseRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::warehouse::WarehouseRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::warehouse::WarehouseRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::warehouse::WarehouseRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::warehouse::WarehouseRevision>>
    where
