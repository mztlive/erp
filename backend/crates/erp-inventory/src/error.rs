//! Inventory-domain application errors with the original unique-index mapping.

use application_core::ErrorClass;

/// Inventory-domain result alias.
...
/// Inventory balance, movement, reservation and adjustment errors.
...
mod tests {
    ...
    #[test]
    fn inventory_unique_conflicts_keep_original_messages() {
