//! Owned MongoDB repository for [`crate::entity::inventory::StockBalance`].

/// Owned repository for `StockBalance`.
///
...
pub struct StockBalanceRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::inventory::StockBalance>,
}

impl<'a> StockBalanceRepository<'a> {
    /// Creates a `StockBalance` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `StockBalance`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `StockBalance`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::inventory::StockBalance> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::inventory::StockBalance,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::inventory::StockBalance>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::inventory::StockBalance,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::inventory::StockBalance: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::inventory::StockBalance>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::inventory::StockBalance>>
    where
