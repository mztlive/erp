//! Owned MongoDB repository for [`crate::entity::inventory::StockAdjustment`].

/// Owned repository for `StockAdjustment`.
///
...
pub struct StockAdjustmentRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::inventory::StockAdjustment>,
}

impl<'a> StockAdjustmentRepository<'a> {
    /// Creates a `StockAdjustment` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `StockAdjustment`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `StockAdjustment`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::inventory::StockAdjustment> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::inventory::StockAdjustment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::inventory::StockAdjustment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::inventory::StockAdjustment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::inventory::StockAdjustment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::inventory::StockAdjustment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::inventory::StockAdjustment>>
    where
