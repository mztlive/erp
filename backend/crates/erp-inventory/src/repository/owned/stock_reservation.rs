//! Owned MongoDB repository for [`crate::entity::inventory::StockReservation`].

/// Owned repository for `StockReservation`.
///
...
pub struct StockReservationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::inventory::StockReservation>,
}

impl<'a> StockReservationRepository<'a> {
    /// Creates a `StockReservation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `StockReservation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `StockReservation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::inventory::StockReservation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::inventory::StockReservation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::inventory::StockReservation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::inventory::StockReservation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::inventory::StockReservation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::inventory::StockReservation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::inventory::StockReservation>>
    where
