//! Owned MongoDB repository for [`crate::entity::inventory::StockAdjustmentLine`].

/// Owned repository for `StockAdjustmentLine`.
///
...
pub struct StockAdjustmentLineRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::inventory::StockAdjustmentLine>,
}

impl<'a> StockAdjustmentLineRepository<'a> {
    /// Creates a `StockAdjustmentLine` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `StockAdjustmentLine`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `StockAdjustmentLine`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::inventory::StockAdjustmentLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::inventory::StockAdjustmentLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::inventory::StockAdjustmentLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::inventory::StockAdjustmentLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::inventory::StockAdjustmentLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::inventory::StockAdjustmentLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::inventory::StockAdjustmentLine>>
    where
