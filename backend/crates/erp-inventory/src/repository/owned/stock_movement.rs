//! Owned MongoDB repository for [`crate::entity::inventory::StockMovement`].

/// Owned repository for `StockMovement`.
///
...
pub struct StockMovementRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::inventory::StockMovement>,
}

impl<'a> StockMovementRepository<'a> {
    /// Creates a `StockMovement` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `StockMovement`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `StockMovement`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::inventory::StockMovement> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::inventory::StockMovement,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::inventory::StockMovement>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::inventory::StockMovement,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::inventory::StockMovement: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::inventory::StockMovement>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::inventory::StockMovement>>
    where
