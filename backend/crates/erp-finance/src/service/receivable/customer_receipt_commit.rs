...
/// 以确定性复现首错语义。
pub fn convert_allocations(
    lines: &[crate::dto::receivable::ReceiptAllocationLineRequest],
...
mod tests {
    ...
    fn allocation(amount: &str) -> crate::dto::receivable::ReceiptAllocationLineRequest {
        crate::dto::receivable::ReceiptAllocationLineRequest {
