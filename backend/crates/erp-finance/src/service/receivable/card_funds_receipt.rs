...
use crate::entity::receivable::{
    CardFundsCommandReceipt, CardFundsCommandReceiptError, CardFundsRegistrationReceiptError,
    EntityCardFundsReviewConclusion, EntityCardFundsReviewResult,
};
...
mod tests {
    ...
    use crate::dto::receivable::{CardFundsReviewConclusion, CardFundsReviewResult};
    use crate::entity::receivable::{
