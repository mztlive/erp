...
mod tests {
    ...
    fn payment_and_receipt_mirror_consistency() {
        let r_a1 = crate::entity::receivable::ReceiptAllocation::new(
            erp_core::ids::ReceiptAllocationId::new("rc-1"),
            crate::entity::receivable::ReceiptAllocationData {
                customer_receipt_id: erp_core::ids::CustomerReceiptId::new("cr-1"),
                receivable_entry_id: erp_core::ids::ReceivableEntryId::new("re-1"),
                allocation_seq: 2,
                allocation_action: crate::entity::receivable::AllocationAction::Apply,
        ...
        .unwrap();
        let r_a2 = crate::entity::receivable::ReceiptAllocation::new(
        ...
        let (r_rows, _) = crate::entity::receivable::ReceiptAllocation::plan_reverse(
            &[r_a1, r_a2],
