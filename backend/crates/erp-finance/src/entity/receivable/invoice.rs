...
pub use super::red_invoice_plan::{
    RedInvoiceAllocationBasis, RedInvoiceAllocationLine, RedInvoiceAllocationPlan,
    RedInvoiceAllocationPlanError, RedInvoiceAllocationReversal,
};
...
/// # 返回
/// 蓝票为增加，红票为减少。
fn derive_accounting_direction(kind: InvoiceKind) -> AccountingDirection {
    match kind {
        InvoiceKind::Blue => AccountingDirection::Increase,
        InvoiceKind::Red => AccountingDirection::Decrease,
    }
}
