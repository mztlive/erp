//! Owned MongoDB repository for [`crate::entity::payable::SupplierPayment`].

/// Owned repository for `SupplierPayment`.
///
...
pub struct SupplierPaymentRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::SupplierPayment>,
}

impl<'a> SupplierPaymentRepository<'a> {
    /// Creates a `SupplierPayment` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierPayment`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierPayment`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::SupplierPayment> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::SupplierPayment,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::SupplierPayment>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::SupplierPayment,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::SupplierPayment: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::SupplierPayment>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::payable::SupplierPayment>>
    where
