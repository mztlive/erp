//! Owned MongoDB repository for [`crate::entity::receivable::Invoice`].

/// Owned repository for `Invoice`.
///
...
pub struct InvoiceRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::Invoice>,
}

impl<'a> InvoiceRepository<'a> {
    /// Creates a `Invoice` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Invoice`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Invoice`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::Invoice> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::Invoice,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::Invoice>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::Invoice,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::Invoice: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::Invoice>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::Invoice>>
    where
