//! Owned MongoDB repository for [`crate::entity::cost::CostAllocation`].

/// Owned repository for `CostAllocation`.
///
...
pub struct CostAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::cost::CostAllocation>,
}

impl<'a> CostAllocationRepository<'a> {
    /// Creates a `CostAllocation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CostAllocation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CostAllocation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::cost::CostAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::cost::CostAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::cost::CostAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::cost::CostAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::cost::CostAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::cost::CostAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::cost::CostAllocation>>
    where
