//! Owned MongoDB repository for [`crate::entity::receivable::SalesInvoiceAllocation`].

/// Owned repository for `SalesInvoiceAllocation`.
///
...
pub struct SalesInvoiceAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::SalesInvoiceAllocation>,
}

impl<'a> SalesInvoiceAllocationRepository<'a> {
    /// Creates a `SalesInvoiceAllocation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesInvoiceAllocation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesInvoiceAllocation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::SalesInvoiceAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::SalesInvoiceAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::SalesInvoiceAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::SalesInvoiceAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::SalesInvoiceAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::SalesInvoiceAllocation>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::receivable::SalesInvoiceAllocation>,
    >
    where
