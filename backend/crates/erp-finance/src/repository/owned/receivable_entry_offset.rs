//! Owned MongoDB repository for [`crate::entity::receivable::ReceivableEntryOffset`].

/// Owned repository for `ReceivableEntryOffset`.
///
...
pub struct ReceivableEntryOffsetRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::ReceivableEntryOffset>,
}

impl<'a> ReceivableEntryOffsetRepository<'a> {
    /// Creates a `ReceivableEntryOffset` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceivableEntryOffset`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceivableEntryOffset`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::ReceivableEntryOffset> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::ReceivableEntryOffset,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::ReceivableEntryOffset>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::ReceivableEntryOffset,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::ReceivableEntryOffset: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::ReceivableEntryOffset>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::receivable::ReceivableEntryOffset>,
    >
    where
