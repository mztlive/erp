//! Owned MongoDB repository for [`crate::entity::cost::CostEntry`].

/// Owned repository for `CostEntry`.
///
...
pub struct CostEntryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::cost::CostEntry>,
}

impl<'a> CostEntryRepository<'a> {
    /// Creates a `CostEntry` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CostEntry`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CostEntry`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::cost::CostEntry> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::cost::CostEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::cost::CostEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::cost::CostEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::cost::CostEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::cost::CostEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::cost::CostEntry>>
    where
