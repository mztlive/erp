//! Owned MongoDB repository for [`crate::entity::receivable::ReceivableAccount`].

/// Owned repository for `ReceivableAccount`.
///
...
pub struct ReceivableAccountRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::ReceivableAccount>,
}

impl<'a> ReceivableAccountRepository<'a> {
    /// Creates a `ReceivableAccount` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceivableAccount`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceivableAccount`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::ReceivableAccount> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::ReceivableAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::ReceivableAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::ReceivableAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::ReceivableAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::ReceivableAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::ReceivableAccount>>
    where
