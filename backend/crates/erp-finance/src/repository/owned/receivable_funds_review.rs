//! Owned MongoDB repository for [`crate::entity::receivable::ReceivableFundsReview`].

/// Owned repository for `ReceivableFundsReview`.
///
...
pub struct ReceivableFundsReviewRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::ReceivableFundsReview>,
}

impl<'a> ReceivableFundsReviewRepository<'a> {
    /// Creates a `ReceivableFundsReview` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceivableFundsReview`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceivableFundsReview`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::ReceivableFundsReview> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::ReceivableFundsReview,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::ReceivableFundsReview>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::ReceivableFundsReview,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::ReceivableFundsReview: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::ReceivableFundsReview>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::receivable::ReceivableFundsReview>,
    >
    where
