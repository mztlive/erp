//! Owned MongoDB repository for [`crate::entity::payable::PayableEntry`].

/// Owned repository for `PayableEntry`.
///
...
pub struct PayableEntryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::PayableEntry>,
}

impl<'a> PayableEntryRepository<'a> {
    /// Creates a `PayableEntry` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PayableEntry`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PayableEntry`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::PayableEntry> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::PayableEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::PayableEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::PayableEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::PayableEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::PayableEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::payable::PayableEntry>>
    where
