//! Owned MongoDB repository for [`crate::entity::payable::PayableAccount`].

/// Owned repository for `PayableAccount`.
///
...
pub struct PayableAccountRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::PayableAccount>,
}

impl<'a> PayableAccountRepository<'a> {
    /// Creates a `PayableAccount` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PayableAccount`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PayableAccount`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::PayableAccount> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::PayableAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::PayableAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::PayableAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::PayableAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::PayableAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::payable::PayableAccount>>
    where
