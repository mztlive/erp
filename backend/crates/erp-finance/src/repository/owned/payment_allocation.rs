//! Owned MongoDB repository for [`crate::entity::payable::PaymentAllocation`].

/// Owned repository for `PaymentAllocation`.
///
...
pub struct PaymentAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::PaymentAllocation>,
}

impl<'a> PaymentAllocationRepository<'a> {
    /// Creates a `PaymentAllocation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PaymentAllocation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PaymentAllocation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::PaymentAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::PaymentAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::PaymentAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::PaymentAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::PaymentAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::PaymentAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::payable::PaymentAllocation>>
    where
