//! Owned MongoDB repository for [`crate::entity::receivable::ReceiptAllocation`].

/// Owned repository for `ReceiptAllocation`.
///
...
pub struct ReceiptAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::ReceiptAllocation>,
}

impl<'a> ReceiptAllocationRepository<'a> {
    /// Creates a `ReceiptAllocation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceiptAllocation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceiptAllocation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::ReceiptAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::ReceiptAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::ReceiptAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::ReceiptAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::ReceiptAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::ReceiptAllocation>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::ReceiptAllocation>>
    where
