//! Owned MongoDB repository for [`crate::entity::receivable::SalesInvoiceRequest`].

/// Owned repository for `SalesInvoiceRequest`.
///
...
pub struct SalesInvoiceRequestRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::SalesInvoiceRequest>,
}

impl<'a> SalesInvoiceRequestRepository<'a> {
    /// Creates a `SalesInvoiceRequest` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesInvoiceRequest`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesInvoiceRequest`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::SalesInvoiceRequest> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::SalesInvoiceRequest,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::SalesInvoiceRequest>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::SalesInvoiceRequest,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::SalesInvoiceRequest: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::SalesInvoiceRequest>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::SalesInvoiceRequest>>
    where
