//! Owned MongoDB repository for [`crate::entity::receivable::ReceivableEntry`].

/// Owned repository for `ReceivableEntry`.
///
...
pub struct ReceivableEntryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::ReceivableEntry>,
}

impl<'a> ReceivableEntryRepository<'a> {
    /// Creates a `ReceivableEntry` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceivableEntry`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceivableEntry`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::ReceivableEntry> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::ReceivableEntry,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::ReceivableEntry>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::ReceivableEntry,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::ReceivableEntry: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::ReceivableEntry>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::ReceivableEntry>>
    where
