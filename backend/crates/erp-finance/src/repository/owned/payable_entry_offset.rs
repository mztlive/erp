//! Owned MongoDB repository for [`crate::entity::payable::PayableEntryOffset`].

/// Owned repository for `PayableEntryOffset`.
///
...
pub struct PayableEntryOffsetRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::PayableEntryOffset>,
}

impl<'a> PayableEntryOffsetRepository<'a> {
    /// Creates a `PayableEntryOffset` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PayableEntryOffset`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PayableEntryOffset`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::PayableEntryOffset> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::PayableEntryOffset,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::PayableEntryOffset>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::PayableEntryOffset,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::PayableEntryOffset: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::PayableEntryOffset>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::payable::PayableEntryOffset>>
    where
