//! Owned MongoDB repository for [`crate::entity::receivable::CustomerReceipt`].

/// Owned repository for `CustomerReceipt`.
///
...
pub struct CustomerReceiptRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::receivable::CustomerReceipt>,
}

impl<'a> CustomerReceiptRepository<'a> {
    /// Creates a `CustomerReceipt` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CustomerReceipt`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CustomerReceipt`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::receivable::CustomerReceipt> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::receivable::CustomerReceipt,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::receivable::CustomerReceipt>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::receivable::CustomerReceipt,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::receivable::CustomerReceipt: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::receivable::CustomerReceipt>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::receivable::CustomerReceipt>>
    where
