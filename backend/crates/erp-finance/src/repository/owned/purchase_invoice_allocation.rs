//! Owned MongoDB repository for [`crate::entity::payable::PurchaseInvoiceAllocation`].

/// Owned repository for `PurchaseInvoiceAllocation`.
///
...
pub struct PurchaseInvoiceAllocationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::payable::PurchaseInvoiceAllocation>,
}

impl<'a> PurchaseInvoiceAllocationRepository<'a> {
    /// Creates a `PurchaseInvoiceAllocation` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PurchaseInvoiceAllocation`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PurchaseInvoiceAllocation`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::payable::PurchaseInvoiceAllocation> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::payable::PurchaseInvoiceAllocation,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::payable::PurchaseInvoiceAllocation>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::payable::PurchaseInvoiceAllocation,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::payable::PurchaseInvoiceAllocation: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::payable::PurchaseInvoiceAllocation>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::payable::PurchaseInvoiceAllocation>,
    >
    where
