...
impl<'a> LegacyImportBatchRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::legacy_import::LegacyImportBatch> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::legacy_import::LegacyImportBatch,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::legacy_import::LegacyImportBatch>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::legacy_import::LegacyImportBatch,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::legacy_import::LegacyImportBatch: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::legacy_import::LegacyImportBatch>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::legacy_import::LegacyImportBatch>>
    where
