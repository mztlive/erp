...
use crate::entity::approval_integration::{ApprovalNotificationDeliveryStatus, ApprovalNotificationOutbox};
...
mod tests {
    ...
    use super::{
        MAX_OUTBOX_BATCH, clamp_outbox_limit, dead_letter_outbox_pipeline, lease_owner_filter,
        lease_take_pipeline, lease_take_sort, mark_outbox_delivered_pipeline, outbox_lease_filter,
        reschedule_outbox_pipeline,
    };
