...
use crate::entity::document_registry::{BusinessDocument, BusinessDocumentId, DocumentType};
...
/// # 错误
/// 无。
pub(super) fn same_id_registration<T>(
    existing: Option<&T>,
    expected_id: &str,
    id_of: impl FnOnce(&T) -> &str,
) -> bool {
...
/// # 错误
/// 无。
pub(super) fn assign_document_no_pipeline(document_no: &str, assigned_at: Instant) -> Vec<Document> {
