//! Owned MongoDB repository for [`crate::entity::work_item::WorkItem`].

/// Owned repository for `WorkItem`.
///
...
pub struct WorkItemRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::work_item::WorkItem>,
}

impl<'a> WorkItemRepository<'a> {
    /// Creates a `WorkItem` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `WorkItem`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `WorkItem`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::work_item::WorkItem> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::work_item::WorkItem,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::work_item::WorkItem>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::work_item::WorkItem,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::work_item::WorkItem: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::work_item::WorkItem>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::work_item::WorkItem>>
    where
