//! Owned MongoDB repository for [`crate::entity::document_registry::WorkflowAction`].

/// Owned repository for `WorkflowAction`.
///
...
pub struct WorkflowActionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::document_registry::WorkflowAction>,
}

impl<'a> WorkflowActionRepository<'a> {
    /// Creates a `WorkflowAction` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `WorkflowAction`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `WorkflowAction`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::document_registry::WorkflowAction> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::document_registry::WorkflowAction,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::document_registry::WorkflowAction>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::document_registry::WorkflowAction,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::document_registry::WorkflowAction: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::document_registry::WorkflowAction>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::document_registry::WorkflowAction>,
    >
    where
