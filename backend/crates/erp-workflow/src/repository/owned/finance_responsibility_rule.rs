//! Owned MongoDB repository for [`crate::entity::work_item::FinanceResponsibilityRule`].

/// Owned repository for `FinanceResponsibilityRule`.
///
...
pub struct FinanceResponsibilityRuleRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::work_item::FinanceResponsibilityRule>,
}

impl<'a> FinanceResponsibilityRuleRepository<'a> {
    /// Creates a `FinanceResponsibilityRule` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `FinanceResponsibilityRule`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `FinanceResponsibilityRule`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::work_item::FinanceResponsibilityRule> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::work_item::FinanceResponsibilityRule,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::work_item::FinanceResponsibilityRule>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::work_item::FinanceResponsibilityRule,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::work_item::FinanceResponsibilityRule: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::work_item::FinanceResponsibilityRule>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::work_item::FinanceResponsibilityRule>,
    >
    where
