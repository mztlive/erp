//! Owned MongoDB repository for [`crate::entity::approval_integration::ApprovalSubjectSnapshot`].

/// Owned repository for `ApprovalSubjectSnapshot`.
///
...
pub struct ApprovalSubjectSnapshotRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::approval_integration::ApprovalSubjectSnapshot>,
}

impl<'a> ApprovalSubjectSnapshotRepository<'a> {
    /// Creates a `ApprovalSubjectSnapshot` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ApprovalSubjectSnapshot`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ApprovalSubjectSnapshot`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::approval_integration::ApprovalSubjectSnapshot> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::approval_integration::ApprovalSubjectSnapshot,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::approval_integration::ApprovalSubjectSnapshot>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::approval_integration::ApprovalSubjectSnapshot,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::approval_integration::ApprovalSubjectSnapshot: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::approval_integration::ApprovalSubjectSnapshot>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::approval_integration::ApprovalSubjectSnapshot>,
    >
    where
