//! Owned MongoDB repository for [`crate::entity::approval_integration::ApprovalNotificationOutbox`].

/// Owned repository for `ApprovalNotificationOutbox`.
///
...
pub struct ApprovalNotificationOutboxRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::approval_integration::ApprovalNotificationOutbox>,
}

impl<'a> ApprovalNotificationOutboxRepository<'a> {
    /// Creates a `ApprovalNotificationOutbox` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ApprovalNotificationOutbox`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ApprovalNotificationOutbox`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::approval_integration::ApprovalNotificationOutbox> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::approval_integration::ApprovalNotificationOutbox,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::approval_integration::ApprovalNotificationOutbox>>
    {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::approval_integration::ApprovalNotificationOutbox,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::approval_integration::ApprovalNotificationOutbox: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::approval_integration::ApprovalNotificationOutbox>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::approval_integration::ApprovalNotificationOutbox>,
    >
    where
