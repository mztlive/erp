...
pub use health::{
    CapabilityVersionSnapshot, SupplierHealthCheckRun, SupplierHealthCheckRunData, SupplierHealthCheckStatus,
    SupplierHealthCheckType,
};
pub use receipt::{
    SupplierCommandOutcome, SupplierConnectionCommandReceipt, SupplierConnectionCommandReceiptData,
};
...
mod tests {
    ...
    use super::*;
    use crate::entity::supplier_api::HealthCheckResult;
    ...
    fn governance_connection(
        ...
        SupplierApiConnection::new(
            ...
            crate::entity::supplier_api::SupplierApiConnectionData {
    ...
    fn governance_capability(code: SupplierApiCapabilityCode) -> SupplierApiCapability {
        SupplierApiCapability::new(
            ...
            crate::entity::supplier_api::SupplierApiCapabilityData {
                connection_id: SupplierApiConnectionId::new("conn-1"),
                capability_code: code,
                status: crate::entity::supplier_api::SupplierApiCapabilityStatus::Active,
