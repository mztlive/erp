//! Owned MongoDB repository for [`crate::entity::supplier_fulfillment::SupplierOrderActionLine`].

/// Owned repository for `SupplierOrderActionLine`.
///
...
pub struct SupplierOrderActionLineRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_fulfillment::SupplierOrderActionLine>,
}

impl<'a> SupplierOrderActionLineRepository<'a> {
    /// Creates a `SupplierOrderActionLine` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierOrderActionLine`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierOrderActionLine`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier_fulfillment::SupplierOrderActionLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_fulfillment::SupplierOrderActionLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_fulfillment::SupplierOrderActionLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_fulfillment::SupplierOrderActionLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_fulfillment::SupplierOrderActionLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_fulfillment::SupplierOrderActionLine>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_fulfillment::SupplierOrderActionLine>,
    >
    where
