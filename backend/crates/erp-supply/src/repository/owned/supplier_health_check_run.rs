//! Owned MongoDB repository for [`crate::entity::supplier_api::SupplierHealthCheckRun`].

/// Owned repository for `SupplierHealthCheckRun`.
///
...
pub struct SupplierHealthCheckRunRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_api::SupplierHealthCheckRun>,
}

impl<'a> SupplierHealthCheckRunRepository<'a> {
    /// Creates a `SupplierHealthCheckRun` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierHealthCheckRun`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierHealthCheckRun`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier_api::SupplierHealthCheckRun> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_api::SupplierHealthCheckRun,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_api::SupplierHealthCheckRun>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_api::SupplierHealthCheckRun,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_api::SupplierHealthCheckRun: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_api::SupplierHealthCheckRun>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_api::SupplierHealthCheckRun>,
    >
    where
