//! Owned MongoDB repository for [`crate::entity::supplier_fulfillment::SupplierRefundFact`].

/// Owned repository for `SupplierRefundFact`.
///
...
pub struct SupplierRefundFactRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_fulfillment::SupplierRefundFact>,
}

impl<'a> SupplierRefundFactRepository<'a> {
    /// Creates a `SupplierRefundFact` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierRefundFact`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierRefundFact`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier_fulfillment::SupplierRefundFact> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_fulfillment::SupplierRefundFact,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_fulfillment::SupplierRefundFact>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_fulfillment::SupplierRefundFact,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_fulfillment::SupplierRefundFact: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_fulfillment::SupplierRefundFact>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_fulfillment::SupplierRefundFact>,
    >
    where
