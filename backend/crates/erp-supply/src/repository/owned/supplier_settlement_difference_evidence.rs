//! Owned MongoDB repository for [`crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence`].
...
impl<'a> SupplierSettlementDifferenceEvidenceRepository<'a> {
    ...
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence,
    ...
    pub async fn find_by_id(
        ...
        Option<crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence>,
    > {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_settlement::SupplierSettlementDifferenceEvidence>>
    {
