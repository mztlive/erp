//! Owned MongoDB repository for [`crate::entity::supplier_fulfillment::SupplierFulfillmentOrder`].

/// Owned repository for `SupplierFulfillmentOrder`.
///
...
pub struct SupplierFulfillmentOrderRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_fulfillment::SupplierFulfillmentOrder>,
}

impl<'a> SupplierFulfillmentOrderRepository<'a> {
    /// Creates a `SupplierFulfillmentOrder` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierFulfillmentOrder`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierFulfillmentOrder`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier_fulfillment::SupplierFulfillmentOrder> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_fulfillment::SupplierFulfillmentOrder,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_fulfillment::SupplierFulfillmentOrder>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_fulfillment::SupplierFulfillmentOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_fulfillment::SupplierFulfillmentOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_fulfillment::SupplierFulfillmentOrder>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_fulfillment::SupplierFulfillmentOrder>,
    >
    where
