//! Owned MongoDB repository for [`crate::entity::supplier_offering::SupplierOfferingAvailability`].

/// Owned repository for `SupplierOfferingAvailability`.
///
...
pub struct SupplierOfferingAvailabilityRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_offering::SupplierOfferingAvailability>,
}

impl<'a> SupplierOfferingAvailabilityRepository<'a> {
    /// Creates a `SupplierOfferingAvailability` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierOfferingAvailability`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierOfferingAvailability`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier_offering::SupplierOfferingAvailability> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_offering::SupplierOfferingAvailability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_offering::SupplierOfferingAvailability>>
    {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_offering::SupplierOfferingAvailability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_offering::SupplierOfferingAvailability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_offering::SupplierOfferingAvailability>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_offering::SupplierOfferingAvailability>,
    >
    where
