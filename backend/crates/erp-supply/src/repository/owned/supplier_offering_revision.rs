//! Owned MongoDB repository for [`crate::entity::supplier_offering::SupplierOfferingRevision`].

/// Owned repository for `SupplierOfferingRevision`.
///
...
pub struct SupplierOfferingRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier_offering::SupplierOfferingRevision>,
}

impl<'a> SupplierOfferingRevisionRepository<'a> {
    /// Creates a `SupplierOfferingRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierOfferingRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierOfferingRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier_offering::SupplierOfferingRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier_offering::SupplierOfferingRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier_offering::SupplierOfferingRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier_offering::SupplierOfferingRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier_offering::SupplierOfferingRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier_offering::SupplierOfferingRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier_offering::SupplierOfferingRevision>,
    >
    where
