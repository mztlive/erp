//! Owned MongoDB repository for [`crate::entity::access_control::UserRole`].

/// Owned repository for `UserRole`.
///
...
pub struct UserRoleRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::access_control::UserRole>,
}

impl<'a> UserRoleRepository<'a> {
    /// Creates a `UserRole` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `UserRole`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `UserRole`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::access_control::UserRole> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::access_control::UserRole,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::access_control::UserRole>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::access_control::UserRole,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::access_control::UserRole: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::access_control::UserRole>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::access_control::UserRole>>
    where
