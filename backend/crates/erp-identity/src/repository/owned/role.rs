//! Owned MongoDB repository for [`crate::entity::Role`].

/// Owned repository for `Role`.
///
...
pub struct RoleRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::Role>,
}

impl<'a> RoleRepository<'a> {
    /// Creates a `Role` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Role`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Role`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::Role> {
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::Role>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::Role,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::Role: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::Role>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::Role>>
    where
