//! Owned MongoDB repository for [`crate::entity::AccountCore`].

/// Owned repository for `AccountCore`.
///
...
pub struct AccountCoreRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::AccountCore>,
}

impl<'a> AccountCoreRepository<'a> {
    /// Creates a `AccountCore` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `AccountCore`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `AccountCore`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::AccountCore> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::AccountCore,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::AccountCore>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::AccountCore,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::AccountCore: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::AccountCore>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::AccountCore>>
    where
