//! Owned MongoDB repository for [`crate::entity::access_control::DataScope`].

/// Owned repository for `DataScope`.
///
...
pub struct DataScopeRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::access_control::DataScope>,
}

impl<'a> DataScopeRepository<'a> {
    /// Creates a `DataScope` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `DataScope`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `DataScope`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::access_control::DataScope> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::access_control::DataScope,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::access_control::DataScope>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::access_control::DataScope,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::access_control::DataScope: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::access_control::DataScope>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::access_control::DataScope>>
    where
