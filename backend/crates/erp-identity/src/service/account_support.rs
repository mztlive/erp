...
pub fn account_of_kind(
    ...
    account
        ...
        .ok_or_else(|| crate::error::Error::NotFound(not_found_message.to_string()))
}
...
/// # 错误
/// * `ConflictError` - 账号已存在
pub async fn ensure_account_available(
    db: &Database,
    ...
    Err(crate::error::Error::ConflictError("账号已存在".into()))
}
