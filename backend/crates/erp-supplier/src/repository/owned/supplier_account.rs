//! Owned MongoDB repository for [`crate::entity::supplier::SupplierAccount`].

/// Owned repository for `SupplierAccount`.
///
...
pub struct SupplierAccountRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierAccount>,
}

impl<'a> SupplierAccountRepository<'a> {
    /// Creates a `SupplierAccount` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierAccount`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierAccount`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier::SupplierAccount> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierAccount,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierAccount>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierAccount,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierAccount: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierAccount>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::supplier::SupplierAccount>>
    where
