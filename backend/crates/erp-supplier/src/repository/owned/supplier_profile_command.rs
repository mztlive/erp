//! Owned MongoDB repository for [`crate::entity::supplier::SupplierProfileCommand`].

/// Owned repository for `SupplierProfileCommand`.
///
...
pub struct SupplierProfileCommandRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierProfileCommand>,
}

impl<'a> SupplierProfileCommandRepository<'a> {
    /// Creates a `SupplierProfileCommand` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierProfileCommand`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierProfileCommand`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier::SupplierProfileCommand> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierProfileCommand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierProfileCommand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierProfileCommand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierProfileCommand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierProfileCommand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::supplier::SupplierProfileCommand>>
    where
