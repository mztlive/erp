//! Owned MongoDB repository for [`crate::entity::supplier::SupplierQualification`].

/// Owned repository for `SupplierQualification`.
///
...
pub struct SupplierQualificationRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierQualification>,
}

impl<'a> SupplierQualificationRepository<'a> {
    /// Creates a `SupplierQualification` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierQualification`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierQualification`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier::SupplierQualification> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierQualification,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierQualification>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierQualification,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierQualification: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierQualification>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::supplier::SupplierQualification>>
    where
