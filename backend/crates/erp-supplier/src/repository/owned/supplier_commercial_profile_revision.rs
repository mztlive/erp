//! Owned MongoDB repository for [`crate::entity::supplier::SupplierCommercialProfileRevision`].

/// Owned repository for `SupplierCommercialProfileRevision`.
///
...
pub struct SupplierCommercialProfileRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierCommercialProfileRevision>,
}

impl<'a> SupplierCommercialProfileRevisionRepository<'a> {
    /// Creates a `SupplierCommercialProfileRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierCommercialProfileRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierCommercialProfileRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier::SupplierCommercialProfileRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierCommercialProfileRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierCommercialProfileRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierCommercialProfileRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierCommercialProfileRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierCommercialProfileRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier::SupplierCommercialProfileRevision>,
    >
    where
