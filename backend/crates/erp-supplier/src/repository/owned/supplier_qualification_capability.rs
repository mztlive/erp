//! Owned MongoDB repository for [`crate::entity::supplier::SupplierQualificationCapability`].

/// Owned repository for `SupplierQualificationCapability`.
///
...
pub struct SupplierQualificationCapabilityRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierQualificationCapability>,
}

impl<'a> SupplierQualificationCapabilityRepository<'a> {
    /// Creates a `SupplierQualificationCapability` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierQualificationCapability`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierQualificationCapability`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(
        &self,
    ) -> mongodb::Collection<crate::entity::supplier::SupplierQualificationCapability> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierQualificationCapability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierQualificationCapability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierQualificationCapability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierQualificationCapability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierQualificationCapability>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::supplier::SupplierQualificationCapability>,
    >
    where
