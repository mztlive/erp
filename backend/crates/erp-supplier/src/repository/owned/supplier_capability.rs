//! Owned MongoDB repository for [`crate::entity::supplier::SupplierCapability`].

/// Owned repository for `SupplierCapability`.
///
...
pub struct SupplierCapabilityRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::supplier::SupplierCapability>,
}

impl<'a> SupplierCapabilityRepository<'a> {
    /// Creates a `SupplierCapability` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierCapability`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierCapability`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::supplier::SupplierCapability> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::supplier::SupplierCapability,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::supplier::SupplierCapability>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::supplier::SupplierCapability,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::supplier::SupplierCapability: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::supplier::SupplierCapability>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::supplier::SupplierCapability>>
    where
