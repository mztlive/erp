...
impl SupplierQualification {
    ...
    pub fn snapshot_revision(
        ...
        revision_no: u32,
    ) -> Result<crate::entity::supplier::SupplierQualificationRevision> {
        crate::entity::supplier::SupplierQualificationRevision::new(
            revision_id,
            crate::entity::supplier::SupplierQualificationRevisionData {
