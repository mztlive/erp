...
impl SupplierCapability {
    ...
    pub fn snapshot_revision(
        ...
        revision_no: u32,
    ) -> Result<crate::entity::supplier::SupplierCapabilityRevision> {
        crate::entity::supplier::SupplierCapabilityRevision::new(
            revision_id,
            crate::entity::supplier::SupplierCapabilityRevisionData {
...
mod tests {
    ...
    fn bson_roundtrip() {
        ...
        let roundtrip: SupplierCapability =
            serde_json::from_value(serde_json::to_value(&capability).unwrap()).unwrap();
