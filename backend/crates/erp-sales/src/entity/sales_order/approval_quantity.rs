...
mod tests {
    ...
    fn goods_line_data(
        line_no: u32,
        quantity: &str,
    ) -> crate::entity::sales_order::submission::SalesOrderSubmissionLineData {
        crate::entity::sales_order::submission::SalesOrderSubmissionLineData {
    ...
    fn goods_header(
        lines: Vec<crate::entity::sales_order::submission::SalesOrderSubmissionLineData>,
    ...
    fn voucher_header(
        line: crate::entity::sales_order::submission::SalesOrderSubmissionLineData,
    ) -> SalesOrderSubmissionData {
