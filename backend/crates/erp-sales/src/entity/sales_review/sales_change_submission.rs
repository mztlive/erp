...
impl SalesChangeSubmissionData {
    ...
    pub fn from_sales_working_copy(
        ...
        if working_copy.working_purpose != crate::entity::sales_order::WorkingPurpose::SalesChange
...
mod tests {
    ...
    fn change_submission_sequence_and_sales_line_mapping_are_entity_owned() {
        ...
        let line = crate::entity::sales_order::SalesOrderWorkingCopyLine {
            ...
            line_no: 1,
            line_type: crate::entity::sales_order::LineType::GoodsService,
            gross_amount: amt("29.97"),
            net_amount: amt("26.07"),
            tax_amount: amt("3.90"),
            sales_tax_rate: rate("0.130000"),
            ...
            welfare_scenario: Some(crate::entity::sales_order::WelfareScenario::MealSubsidy),
            service_region: None,
        ...
        .unwrap();
        let working_copy = crate::entity::sales_order::SalesOrderWorkingCopy {
            base: BaseModel::new("wc-1".to_string()),
            stable: StableBase::new(crate::entity::sales_order::WorkingCopyStatus::Editing, "sales-1"),
            sales_order_id: SalesOrderId::new("o-1"),
            working_purpose: crate::entity::sales_order::WorkingPurpose::SalesChange,
            ...
            business_type: crate::entity::sales_order::BusinessType::GoodsService,
            customer_id: CustomerAccountId::new("cust-1"),
            contract_id: Some(erp_core::ids::ContractId::new("contract-1")),
            contract_revision_id: Some(ContractRevisionId::new("contract-rev-1")),
            settlement_party_id: PartyId::new("party-1"),
            customer_snapshot: crate::entity::sales_order::CustomerSnapshot {
                customer_name: "东方企业".to_string(),
            },
            contract_snapshot: Some(crate::entity::sales_order::ContractSnapshot {
                contract_no: "HT-1".to_string(),
            }),
            settlement_party_snapshot: Some(crate::entity::sales_order::SettlementPartySnapshot {
                settlement_party_name: "结算中心".to_string(),
            }),
            payment_term_snapshot: crate::entity::sales_order::PaymentTermSnapshot {
                payment_term_code: "NET30".to_string(),
                payment_term_name: "月结30天".to_string(),
            },
            invoice_requirement_snapshot: crate::entity::sales_order::InvoiceRequirementSnapshot {
