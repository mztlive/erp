...
/// # 错误
/// 行字段组与行类型不一致、金额非法时返回错误。
pub fn build_working_copy_lines(
...
pub fn header_snapshot(
    ...
    Ok(crate::entity::sales_order::HeaderSnapshotData {
