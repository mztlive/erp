...
impl SalesOrderService {
    ...
    pub async fn ensure_sellable_draft_lines(
        ...
        let refs = lines
            ...
            .collect::<Vec<_>>();
        self.ensure_sellable_refs(&refs, port, &mut NoTransaction).await
    }
    ...
    pub fn sellable_working_copy_refs(lines: &[SalesOrderWorkingCopyLine]) -> Result<Vec<(String, String)>> {
        lines
            .iter()
