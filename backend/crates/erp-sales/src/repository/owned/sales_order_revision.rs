//! Owned MongoDB repository for [`crate::entity::sales_order::SalesOrderRevision`].

/// Owned repository for `SalesOrderRevision`.
///
...
pub struct SalesOrderRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::sales_order::SalesOrderRevision>,
}

impl<'a> SalesOrderRevisionRepository<'a> {
    /// Creates a `SalesOrderRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesOrderRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesOrderRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::sales_order::SalesOrderRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::sales_order::SalesOrderRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::sales_order::SalesOrderRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::sales_order::SalesOrderRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::sales_order::SalesOrderRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::sales_order::SalesOrderRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::sales_order::SalesOrderRevision>>
    where
