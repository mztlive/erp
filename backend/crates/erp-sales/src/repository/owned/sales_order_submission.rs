//! Owned MongoDB repository for [`crate::entity::sales_order::SalesOrderSubmission`].

/// Owned repository for `SalesOrderSubmission`.
///
...
pub struct SalesOrderSubmissionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::sales_order::SalesOrderSubmission>,
}

impl<'a> SalesOrderSubmissionRepository<'a> {
    /// Creates a `SalesOrderSubmission` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesOrderSubmission`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesOrderSubmission`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::sales_order::SalesOrderSubmission> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::sales_order::SalesOrderSubmission,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::sales_order::SalesOrderSubmission>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::sales_order::SalesOrderSubmission,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::sales_order::SalesOrderSubmission: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::sales_order::SalesOrderSubmission>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::sales_order::SalesOrderSubmission>,
    >
    where
