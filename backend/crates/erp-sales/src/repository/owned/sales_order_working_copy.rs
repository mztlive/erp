//! Owned MongoDB repository for [`crate::entity::sales_order::SalesOrderWorkingCopy`].

/// Owned repository for `SalesOrderWorkingCopy`.
///
...
pub struct SalesOrderWorkingCopyRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::sales_order::SalesOrderWorkingCopy>,
}

impl<'a> SalesOrderWorkingCopyRepository<'a> {
    /// Creates a `SalesOrderWorkingCopy` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesOrderWorkingCopy`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesOrderWorkingCopy`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::sales_order::SalesOrderWorkingCopy> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::sales_order::SalesOrderWorkingCopy,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::sales_order::SalesOrderWorkingCopy>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::sales_order::SalesOrderWorkingCopy,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::sales_order::SalesOrderWorkingCopy: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::sales_order::SalesOrderWorkingCopy>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::sales_order::SalesOrderWorkingCopy>,
    >
    where
