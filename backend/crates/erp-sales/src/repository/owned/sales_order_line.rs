//! Owned MongoDB repository for [`crate::entity::sales_order::SalesOrderLine`].

/// Owned repository for `SalesOrderLine`.
///
...
pub struct SalesOrderLineRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::sales_order::SalesOrderLine>,
}

impl<'a> SalesOrderLineRepository<'a> {
    /// Creates a `SalesOrderLine` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesOrderLine`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesOrderLine`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::sales_order::SalesOrderLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::sales_order::SalesOrderLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::sales_order::SalesOrderLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::sales_order::SalesOrderLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::sales_order::SalesOrderLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::sales_order::SalesOrderLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::sales_order::SalesOrderLine>>
    where
