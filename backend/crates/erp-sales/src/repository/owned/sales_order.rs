//! Owned MongoDB repository for [`crate::entity::sales_order::SalesOrder`].
...
pub struct SalesOrderRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::sales_order::SalesOrder>,
}
...
impl<'a> SalesOrderRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::sales_order::SalesOrder> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::sales_order::SalesOrder,
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::sales_order::SalesOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::sales_order::SalesOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::sales_order::SalesOrder>>
    where
