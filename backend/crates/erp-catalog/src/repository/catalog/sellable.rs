...
use crate::entity::catalog::{EnableStatus, ListingStatus, ProductKind, Sku};
use crate::ports::supply::{AvailabilityStatus, OfferingStatus};
...
const SUPPLIER_OFFERING_REVISIONS: &str = crate::ports::supply::SUPPLIER_OFFERING_REVISIONS;
/// `supplier_offering_availability` 集合名（公司商品池资格依赖的实时可供投影）。
const SUPPLIER_OFFERING_AVAILABILITIES: &str = crate::ports::supply::SUPPLIER_OFFERING_AVAILABILITIES;
