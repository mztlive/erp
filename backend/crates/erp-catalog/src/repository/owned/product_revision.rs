//! Owned MongoDB repository for [`crate::entity::catalog::ProductRevision`].
...
pub struct ProductRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::ProductRevision>,
}

impl<'a> ProductRevisionRepository<'a> {
    /// Creates a `ProductRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ProductRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ProductRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::ProductRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::ProductRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::ProductRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::ProductRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::ProductRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::ProductRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::ProductRevision>>
    where
