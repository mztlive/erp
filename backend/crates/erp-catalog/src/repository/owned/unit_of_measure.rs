//! Owned MongoDB repository for [`crate::entity::catalog::UnitOfMeasure`].
...
pub struct UnitOfMeasureRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::UnitOfMeasure>,
}

impl<'a> UnitOfMeasureRepository<'a> {
    /// Creates a `UnitOfMeasure` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `UnitOfMeasure`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `UnitOfMeasure`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::UnitOfMeasure> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::UnitOfMeasure,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::UnitOfMeasure>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::UnitOfMeasure,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::UnitOfMeasure: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::UnitOfMeasure>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::UnitOfMeasure>>
    where
