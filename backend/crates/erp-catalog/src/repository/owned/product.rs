//! Owned MongoDB repository for [`crate::entity::catalog::Product`].
...
pub struct ProductRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::Product>,
}

impl<'a> ProductRepository<'a> {
    /// Creates a `Product` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Product`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Product`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::Product> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::Product,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::Product>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::Product,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::Product: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::Product>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::Product>>
    where
