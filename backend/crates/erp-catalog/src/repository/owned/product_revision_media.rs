//! Owned MongoDB repository for [`crate::entity::catalog::ProductRevisionMedia`].
...
pub struct ProductRevisionMediaRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::ProductRevisionMedia>,
}

impl<'a> ProductRevisionMediaRepository<'a> {
    /// Creates a `ProductRevisionMedia` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ProductRevisionMedia`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ProductRevisionMedia`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::ProductRevisionMedia> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::ProductRevisionMedia,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::ProductRevisionMedia>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::ProductRevisionMedia,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::ProductRevisionMedia: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::ProductRevisionMedia>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::ProductRevisionMedia>>
    where
