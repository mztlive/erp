//! Owned MongoDB repository for [`crate::entity::catalog::ProductCategoryAttribute`].
...
pub struct ProductCategoryAttributeRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::ProductCategoryAttribute>,
}

impl<'a> ProductCategoryAttributeRepository<'a> {
    /// Creates a `ProductCategoryAttribute` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ProductCategoryAttribute`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ProductCategoryAttribute`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::ProductCategoryAttribute> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::ProductCategoryAttribute,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::ProductCategoryAttribute>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::ProductCategoryAttribute,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::ProductCategoryAttribute: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::ProductCategoryAttribute>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::catalog::ProductCategoryAttribute>,
    >
    where
