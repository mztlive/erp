//! Owned MongoDB repository for [`crate::entity::catalog::Sku`].
...
pub struct SkuRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::Sku>,
}

impl<'a> SkuRepository<'a> {
    /// Creates a `Sku` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `Sku`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `Sku`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::Sku> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::Sku,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::Sku>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::Sku,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::Sku: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::Sku>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::Sku>>
    where
