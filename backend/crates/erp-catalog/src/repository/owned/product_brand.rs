//! Owned MongoDB repository for [`crate::entity::catalog::ProductBrand`].
...
pub struct ProductBrandRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::ProductBrand>,
}

impl<'a> ProductBrandRepository<'a> {
    /// Creates a `ProductBrand` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ProductBrand`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ProductBrand`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::ProductBrand> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::ProductBrand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::ProductBrand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::ProductBrand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::ProductBrand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::ProductBrand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::ProductBrand>>
    where
