//! Owned MongoDB repository for [`crate::entity::catalog::VoucherCategoryProfileRevision`].
...
pub struct VoucherCategoryProfileRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::VoucherCategoryProfileRevision>,
}

impl<'a> VoucherCategoryProfileRevisionRepository<'a> {
    /// Creates a `VoucherCategoryProfileRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `VoucherCategoryProfileRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `VoucherCategoryProfileRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::VoucherCategoryProfileRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::VoucherCategoryProfileRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::VoucherCategoryProfileRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::VoucherCategoryProfileRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::VoucherCategoryProfileRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::VoucherCategoryProfileRevision>> {
    ...
    pub async fn search<F>(
        ...
        persistence_core::PageResult<crate::entity::catalog::VoucherCategoryProfileRevision>,
    >
    where
