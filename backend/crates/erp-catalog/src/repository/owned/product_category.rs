//! Owned MongoDB repository for [`crate::entity::catalog::ProductCategory`].
...
pub struct ProductCategoryRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::ProductCategory>,
}

impl<'a> ProductCategoryRepository<'a> {
    /// Creates a `ProductCategory` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ProductCategory`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ProductCategory`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::ProductCategory> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::ProductCategory,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::ProductCategory>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::ProductCategory,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::ProductCategory: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::ProductCategory>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::ProductCategory>>
    where
