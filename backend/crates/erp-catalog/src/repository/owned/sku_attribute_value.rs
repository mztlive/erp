//! Owned MongoDB repository for [`crate::entity::catalog::SkuAttributeValue`].
...
pub struct SkuAttributeValueRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::SkuAttributeValue>,
}

impl<'a> SkuAttributeValueRepository<'a> {
    /// Creates a `SkuAttributeValue` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SkuAttributeValue`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SkuAttributeValue`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::SkuAttributeValue> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::SkuAttributeValue,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::SkuAttributeValue>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::SkuAttributeValue,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::SkuAttributeValue: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::SkuAttributeValue>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::SkuAttributeValue>>
    where
