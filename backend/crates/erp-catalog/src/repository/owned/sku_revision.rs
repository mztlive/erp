//! Owned MongoDB repository for [`crate::entity::catalog::SkuRevision`].
...
pub struct SkuRevisionRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::SkuRevision>,
}

impl<'a> SkuRevisionRepository<'a> {
    /// Creates a `SkuRevision` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SkuRevision`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SkuRevision`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::SkuRevision> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::SkuRevision,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::SkuRevision>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::SkuRevision,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::SkuRevision: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::SkuRevision>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::SkuRevision>>
    where
