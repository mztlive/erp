//! Owned MongoDB repository for [`crate::entity::catalog::SkuAttribute`].
...
pub struct SkuAttributeRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::catalog::SkuAttribute>,
}

impl<'a> SkuAttributeRepository<'a> {
    /// Creates a `SkuAttribute` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SkuAttribute`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SkuAttribute`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::catalog::SkuAttribute> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::catalog::SkuAttribute,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::catalog::SkuAttribute>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::catalog::SkuAttribute,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::catalog::SkuAttribute: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::catalog::SkuAttribute>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::catalog::SkuAttribute>>
    where
