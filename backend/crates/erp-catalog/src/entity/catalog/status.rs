...
mod tests {
    ...
    fn product_listing_status_is_inherited_from_sku_counts() {
        assert_eq!(ProductListingStatus::inherited(2, 2), ProductListingStatus::Listed);
        assert_eq!(ProductListingStatus::inherited(1, 2), ProductListingStatus::PartiallyListed);
        assert_eq!(ProductListingStatus::inherited(0, 2), ProductListingStatus::Unlisted);
        assert_eq!(ProductListingStatus::inherited(0, 0), ProductListingStatus::Unlisted);
