...
mod tests {
    ...
    fn confirmation(decision: erp_import::ConfirmationDecision) -> erp_import::LegacyImportConfirmation {
        ...
        .unwrap();
        match decision {
            erp_import::ConfirmationDecision::ConfirmScope => {
                confirmation
                    .decide(
                        decision,
                        "user-1",
    ...
    fn workflow_action_maps_both_decisions() {
        ...
        let confirmed = confirmation(erp_import::ConfirmationDecision::ConfirmScope);
        let action =
        ...
        let rejected = confirmation(erp_import::ConfirmationDecision::ReturnForFix);
        let action =
