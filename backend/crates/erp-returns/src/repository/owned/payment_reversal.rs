//! Owned MongoDB repository for [`crate::entity::returns::PaymentReversal`].

/// Owned repository for `PaymentReversal`.
///
...
pub struct PaymentReversalRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::PaymentReversal>,
}

impl<'a> PaymentReversalRepository<'a> {
    /// Creates a `PaymentReversal` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PaymentReversal`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PaymentReversal`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::PaymentReversal> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::PaymentReversal,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::PaymentReversal>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::PaymentReversal,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::PaymentReversal: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::PaymentReversal>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::PaymentReversal>>
    where
