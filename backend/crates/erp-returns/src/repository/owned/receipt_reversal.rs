//! Owned MongoDB repository for [`crate::entity::returns::ReceiptReversal`].

/// Owned repository for `ReceiptReversal`.
///
...
pub struct ReceiptReversalRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::ReceiptReversal>,
}

impl<'a> ReceiptReversalRepository<'a> {
    /// Creates a `ReceiptReversal` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `ReceiptReversal`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `ReceiptReversal`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::ReceiptReversal> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::ReceiptReversal,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::ReceiptReversal>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::ReceiptReversal,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::ReceiptReversal: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::ReceiptReversal>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::ReceiptReversal>>
    where
