//! Owned MongoDB repository for [`crate::entity::returns::SalesReturnCase`].

/// Owned repository for `SalesReturnCase`.
///
...
pub struct SalesReturnCaseRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::SalesReturnCase>,
}

impl<'a> SalesReturnCaseRepository<'a> {
    /// Creates a `SalesReturnCase` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesReturnCase`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesReturnCase`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::SalesReturnCase> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::SalesReturnCase,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::SalesReturnCase>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::SalesReturnCase,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::SalesReturnCase: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::SalesReturnCase>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::SalesReturnCase>>
    where
