//! Owned MongoDB repository for [`crate::entity::returns::CustomerRefund`].

/// Owned repository for `CustomerRefund`.
///
...
pub struct CustomerRefundRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::CustomerRefund>,
}

impl<'a> CustomerRefundRepository<'a> {
    /// Creates a `CustomerRefund` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `CustomerRefund`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `CustomerRefund`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::CustomerRefund> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::CustomerRefund,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::CustomerRefund>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::CustomerRefund,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::CustomerRefund: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::CustomerRefund>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::CustomerRefund>>
    where
