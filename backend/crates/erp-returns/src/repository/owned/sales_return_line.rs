//! Owned MongoDB repository for [`crate::entity::returns::SalesReturnLine`].

/// Owned repository for `SalesReturnLine`.
///
...
pub struct SalesReturnLineRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::SalesReturnLine>,
}

impl<'a> SalesReturnLineRepository<'a> {
    /// Creates a `SalesReturnLine` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SalesReturnLine`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SalesReturnLine`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::SalesReturnLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::SalesReturnLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::SalesReturnLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::SalesReturnLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::SalesReturnLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::SalesReturnLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::SalesReturnLine>>
    where
