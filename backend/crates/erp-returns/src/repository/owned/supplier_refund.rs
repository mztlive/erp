//! Owned MongoDB repository for [`crate::entity::returns::SupplierRefund`].

/// Owned repository for `SupplierRefund`.
///
...
pub struct SupplierRefundRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::SupplierRefund>,
}

impl<'a> SupplierRefundRepository<'a> {
    /// Creates a `SupplierRefund` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `SupplierRefund`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `SupplierRefund`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::SupplierRefund> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::SupplierRefund,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::SupplierRefund>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::SupplierRefund,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::SupplierRefund: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::SupplierRefund>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::SupplierRefund>>
    where
