//! Owned MongoDB repository for [`crate::entity::returns::PurchaseReturnOrder`].

/// Owned repository for `PurchaseReturnOrder`.
///
...
pub struct PurchaseReturnOrderRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::PurchaseReturnOrder>,
}

impl<'a> PurchaseReturnOrderRepository<'a> {
    /// Creates a `PurchaseReturnOrder` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PurchaseReturnOrder`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PurchaseReturnOrder`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::PurchaseReturnOrder> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::PurchaseReturnOrder,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::PurchaseReturnOrder>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::PurchaseReturnOrder,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::PurchaseReturnOrder: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::PurchaseReturnOrder>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::PurchaseReturnOrder>>
    where
