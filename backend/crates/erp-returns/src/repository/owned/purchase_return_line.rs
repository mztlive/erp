//! Owned MongoDB repository for [`crate::entity::returns::PurchaseReturnLine`].

/// Owned repository for `PurchaseReturnLine`.
///
...
pub struct PurchaseReturnLineRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::returns::PurchaseReturnLine>,
}

impl<'a> PurchaseReturnLineRepository<'a> {
    /// Creates a `PurchaseReturnLine` repository bound to `collection_name`.
    ///
    /// # Parameters
    /// * `db` - MongoDB database handle
    /// * `collection_name` - collection name for `PurchaseReturnLine`
    ///
    /// # Returns
    ...
    /// Returns the MongoDB collection handle for `PurchaseReturnLine`.
    ///
    /// # Returns
    /// Typed collection handle for this repository's collection.
    pub fn collection(&self) -> mongodb::Collection<crate::entity::returns::PurchaseReturnLine> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::returns::PurchaseReturnLine,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::returns::PurchaseReturnLine>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::returns::PurchaseReturnLine,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::returns::PurchaseReturnLine: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::returns::PurchaseReturnLine>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::returns::PurchaseReturnLine>>
    where
