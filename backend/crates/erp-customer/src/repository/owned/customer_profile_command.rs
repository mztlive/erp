...
pub struct CustomerProfileCommandRepository<'a> {
    inner: persistence_core::Repository<'a, crate::entity::customer::CustomerProfileCommand>,
}
...
impl<'a> CustomerProfileCommandRepository<'a> {
    ...
    pub fn collection(&self) -> mongodb::Collection<crate::entity::customer::CustomerProfileCommand> {
    ...
    pub async fn create(
        &self,
        entity: &crate::entity::customer::CustomerProfileCommand,
    ...
    pub async fn find_by_id(
        ...
        id: &str,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Option<crate::entity::customer::CustomerProfileCommand>> {
    ...
    pub async fn update(
        &self,
        entity: &mut crate::entity::customer::CustomerProfileCommand,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<()>
    where
        crate::entity::customer::CustomerProfileCommand: entity_core::HasBaseModel,
    {
    ...
    pub async fn list_all(
        &self,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<Vec<crate::entity::customer::CustomerProfileCommand>> {
    ...
    pub async fn search<F>(
        ...
        filter: &F,
        executor: &mut dyn persistence_core::Executor,
    ) -> persistence_core::Result<persistence_core::PageResult<crate::entity::customer::CustomerProfileCommand>>
    where
