...
mod electronic_delivery_no_approval_tests {
    use super::{
        BindingDecision, DocumentApprovalPolicy, DocumentType, ElectronicDelivery, ElectronicDeliveryData,
        ...
        ensure_electronic_delivery_skips_approval_binding, policy_of,
    };
