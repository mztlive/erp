...
/// # 返回
/// 返回 `START_APPROVAL`。
pub fn command_kind_of_start(
    _command: &super::dto::ApprovalStartCommand,
...
/// # 返回
/// 返回 `SUBMIT_DECISION`。
pub fn command_kind_of_decision(
    _command: &super::dto::ApprovalDecisionCommand,
) -> bpm::model::types::ApprovalCommandKind {
    bpm::model::types::ApprovalCommandKind::SubmitDecision
}
...
/// # 返回
/// 返回 `CANCEL_APPROVAL`。
pub fn command_kind_of_cancel(
    _command: &super::dto::ApprovalCancelCommand,
) -> bpm::model::types::ApprovalCommandKind {
    bpm::model::types::ApprovalCommandKind::CancelApproval
}
...
/// # 返回
/// 返回 `RESUME_APPROVER`。
pub fn command_kind_of_resume(
    _command: &super::dto::ApprovalResumeCommand,
) -> bpm::model::types::ApprovalCommandKind {
    bpm::model::types::ApprovalCommandKind::ResumeApprover
}
...
///
/// # 返回
/// 返回 `REASSIGN_APPROVER`。
pub fn command_kind_of_reassign(
    _command: &super::dto::ApprovalReassignCommand,
) -> bpm::model::types::ApprovalCommandKind {
    bpm::model::types::ApprovalCommandKind::ReassignApprover
}
...
/// # 返回
/// 返回 `CANCEL_BLOCKED`。
pub fn command_kind_of_cancel_blocked(
    _command: &super::dto::ApprovalCancelBlockedCommand,
) -> bpm::model::types::ApprovalCommandKind {
    bpm::model::types::ApprovalCommandKind::CancelBlocked
}
