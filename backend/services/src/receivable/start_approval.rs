...
use database::{ApprovalIntegrationExt, BpmExt, DocumentRegistryExt, ReceivableExt, WorkItemExt};
...
pub(super) struct CustomerReceiptStartPersistInput {
    /// 已进入 `IN_APPROVAL` 的回款单。
