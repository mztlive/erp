...
const ORDER_COLUMNS: ColumnDef<OrderRow, unknown>[] = [
  ...
  },
  {
    accessorKey: "amount",
    header: "含税金额",
    meta: { label: "含税金额", align: "end", numeric: true },
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: "数量",
    meta: { label: "数量", align: "end", numeric: true },
    cell: ({ row }) => (
  ...
  },
  {
    accessorKey: "rate",
    header: "配赠率",
    meta: { label: "配赠率", align: "end", numeric: true },
...
const LINE_COLUMNS: EditableLineItemColumn<LineItem>[] = [
  ...
  },
  {
    ...
    align: "end",
    numeric: true,
    renderValue: ({ item }) => <QuantityValue value={item.quantity} unit="份" />,
    renderEditor: ({ item, rowIndex }) => (
      <Input
...
export default function BusinessComponentsPreviewPage() {
  ...
  const [selectionScope, setSelectionScope] = React.useState<"page" | "filtered">("page")
  ...
  const [savedView, setSavedView] = React.useState<string | undefined>("pending")
  const [businessObject, setBusinessObject] = React.useState<string | undefined>(
    "customer-01"
  )
  ...
  return (
    <ErpAppShell
      ...
      taskTabs={
        <TaskTabs
          ...
          items={[
            { value: "components", label: "业务组件", icon: LayoutDashboardIcon },
    ...
    >
      <main className="mx-auto flex w-full max-w-7xl flex-col gap-6 p-4 lg:p-6">
        <PageHeader
          title="业务组件库"
          description="63 个业务组件的静态预览与交互验收；基础色彩、密度和状态语义请对照 Theme 页面。"
          breadcrumbs={[
        ...
        <Tabs value={section} onValueChange={setSection}>
          <TabsList variant="line" aria-label="业务组件分组" className="max-w-full overflow-x-auto">
          ...
          <TabsContent value="lists" className="space-y-6">
            ...
            >
              <WorkTaskItem
                ...
                nextAction={<Button size="sm" onClick={noop}>打开任务</Button>}
              />
            </ShowcaseSection>
              ...
              <BusinessTableFrame
                ...
                toolbar={
                  <ListToolbar
                    savedView={
                      <SavedViewPicker
                        views={[
                          { id: "pending", label: "我的待处理", scope: "personal" },
                          { id: "team", label: "团队全部订单", scope: "team", readOnly: true },
                        ]}
                        value={savedView}
                        onValueChange={setSavedView}
                      />
                    }
                    search={<Input aria-label="搜索销售订单" placeholder="单号、客户或外部单号" />}
                    filters={
                ...
                selectionBar={
                  <SelectionScopeBar
                    ...
                    selectedCount={selectionScope === "filtered" ? 128 : selectedCount}
                    pageItemCount={ORDERS.length}
                    filteredCount={128}
                    filterSummary="状态：待审批、已生效"
                    onScopeChange={setSelectionScope}
                    onClearSelection={() => setRowSelection({})}
                    actions={<Button size="sm" variant="secondary" onClick={noop}>批量导出</Button>}
                  />
                }
                table={
                  <DataTable
                ...
                footer={
                  <>
                    <span className="text-xs text-muted-foreground">显示服务端准确总数</span>
            ...
            >
              <div className="space-y-6">
                <DocumentHeader
                  ...
                  statuses={[
                    { id: "fulfillment", label: "履约", status: { label: "部分履约", tone: "warning" } },
                    { id: "payment", label: "回款", status: { label: "待复核", tone: "info" } },
                    { id: "invoice", label: "开票", status: { label: "未开", tone: "neutral" } },
                  ]}
                  secondaryActions={
                    <ConflictResolutionDialog
                      ...
                      actor="王敏"
                      changedAt="18:12"
                      diff={<p className="text-sm">含税金额由 ¥1,260,000.00 调整为 ¥1,284,650.00。</p>}
                      onReload={noop}
                      onSaveCopy={noop}
                      onCompare={noop}
                    />
                ...
                <StatusTrackSummary
                  variant="table"
                  tracks={[
                    { id: "main", label: "主状态", status: { label: "已生效", tone: "success", description: "版本 v4" } },
                    { id: "fulfillment", label: "履约", status: { label: "部分履约", tone: "warning", description: "2 个责任轨道进行中" } },
                    { id: "payment", label: "回款", status: { label: "待复核", tone: "info", description: "最近到账待认领" } },
                  ]}
                />
                ...
                <DocumentSummary
                  columns="four"
                  items={[
                    { id: "customer", label: "客户", value: "北方能源集团", emphasized: true },
                    { id: "owner", label: "销售负责人", value: "赵晨" },
                    { id: "effective", label: "生效时间", value: "2026-07-31 16:02" },
                    { id: "amount", label: "含税总额", value: <MoneyValue value="1284650.00" taxBasis="gross" />, numeric: true },
                  ]}
                />
                ...
                <DocumentSection
                  ...
                  action={<DraftSaveIndicator state="saved" savedAt="18:20:06" />}
                >
                  <EditableLineItemTable
                    items={LINE_ITEMS}
                    ...
                    tracks={[
                      {
                        ...
                        owner: "履约运营组",
                        dueAt: { dateTime: "2026-08-05T18:00:00+08:00", label: "08-05 18:00" },
                        action: <Button size="sm" onClick={noop}>查看履约</Button>,
                      },
                      {
                        id: "invoice",
                        label: "开票",
                      ...
                      documents={[
                        {
                          ...
                          measure: { kind: "quantity", value: "260", unit: "份" },
                          owner: "履约运营组",
                          openAction: <Button size="sm" variant="ghost" onClick={noop}>打开</Button>,
                        },
                      ]}
                    />
                  </DocumentSection>
                      ...
                      revisions={[
                        {
                          ...
                          source: "erp-change",
                          actor: "王敏",
                          effectiveAt: { dateTime: "2026-07-31T18:12:00+08:00", label: "07-31 18:12" },
                        ...
                        },
                        {
                          ...
                          source: "mall-sync",
                          actor: "商城同步任务",
                          effectiveAt: { dateTime: "2026-07-31T16:02:00+08:00", label: "07-31 16:02" },
                        },
                      ]}
                    />
                  </DocumentSection>
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                  <DocumentTotals
                    items={[
                      { id: "gross", label: "含税总额", basis: "销售口径", value: <MoneyValue value="1284650.00" taxBasis="gross" /> },
                      { id: "paid", label: "已分配回款", basis: "过账净额", value: <MoneyValue value="620000.00" /> },
                    ]}
                    warning="成本覆盖不完整时，利润值必须与覆盖率一起解读。"
                  />
                  <DocumentAttachmentList
                    attachments={[
                      { id: "contract", name: "采购合同.pdf", state: "done", required: true, description: "2.4 MB · 已完成病毒扫描", onOpen: noop },
                      { id: "quote", name: "报价确认单.xlsx", state: "processing", description: "正在解析" },
                      { id: "evidence", name: "客户盖章页.png", state: "error", errorMessage: "文件校验失败", onRetry: noop },
                    ]}
                  />
                </div>
              </div>
            ...
            >
              <div className="space-y-6">
                <EditorPresence
                  ...
                  viewers={[{ id: "u2", name: "赵晨" }, { id: "u3", name: "陈莉" }]}
                />
                <SequentialProcessBar
                  current={3}
                  total={12}
                ...
                <div className="grid gap-6 xl:grid-cols-2">
                  <ApprovalDecisionPanel
                    summaryItems={[
                      { id: "amount", label: "审批金额", value: <MoneyValue value="1284650.00" />, numeric: true },
                      { id: "discount", label: "折扣率", value: <RateValue value="92.00" precision={2} />, numeric: true },
                    ]}
                    opinionField={
                  ...
                  <AllocationWorkspace
                    ...
                    statusNotice={<BusinessStatusBadge label="分配平衡" tone="success" context="detail" description="差额为零" />}
          ...
          <TabsContent value="domains" className="space-y-6">
            ...
            >
              <div className="space-y-6">
                <PrepaymentGate
                  condition={{ kind: "ratio", required: "50.00%", description: "按有效净付款分配计算" }}
                  allocated="48.26%"
                  gap="1.74%"
                  updatedAt={{ dateTime: "2026-07-31T18:26:00+08:00", label: "07-31 18:26" }}
                  allowed={false}
                  paymentAction={<Button variant="outline" onClick={noop}>查看付款分配</Button>}
                />
                <InventoryBalanceSummary
                  onHand="1,280"
                  reserved="360"
                  ...
                  pendingOutbound="260"
                  unit="份"
                  updatedAt={{ dateTime: "2026-07-31T18:25:00+08:00", label: "07-31 18:25" }}
                />
              </div>
            </ShowcaseSection>
            ...
            >
              <div className="space-y-6">
                <AfterSalesTrackPanel
                  request={{ applicability: "required", status: "completed", description: "客户取消 20 张电子卡", owner: "客户运营组", occurredAt: { dateTime: "2026-07-31T17:00:00+08:00", label: "07-31 17:00" }, evidence: "ASR-20260731-009" }}
                  refund={{ applicability: "required", status: "pending", amount: "¥19,400.00", owner: "商城售后组", action: <Button size="sm" onClick={noop}>查看退款</Button> }}
                  balanceRestoration={{ applicability: "required", status: "completed", amount: "¥20,000.00", owner: "卡券运营组", evidence: "余额恢复回执编号 4481" }}
                  supplierRefund={{ applicability: "not-applicable", status: "not-applicable", reason: "本次订单未发生供应商采购" }}
                />
                <CostCoverageNotice
                  basis="STANDARD"
                  ...
                  breakdown={{ ACTUAL: "¥286,000.00", STANDARD: "¥918,650.00", NONE: "¥80,000.00" }}
                ...
                <InterfaceErrorResolutionPanel
                  ...
                  latestAttempt={{
                    attemptNumber: 2,
                    attemptedAt: { dateTime: "2026-07-31T18:08:00+08:00", label: "07-31 18:08" },
                    result: "请求超时，未取得供应商终态",
                    requestSummary: "幂等键已保留，敏感参数已脱敏",
                    responseSummary: "HTTP 504",
                  }}
                  actions={{ stage: "query-original", queryOriginal: <Button size="sm" onClick={noop}>查询原结果</Button> }}
                />
              </div>
            </ShowcaseSection>
          </TabsContent>
          ...
          <TabsContent value="feedback" className="space-y-6">
            ...
            >
              <div className="space-y-6">
                <div className="grid gap-6 xl:grid-cols-2">
                  <BusinessEmptyState
                    kind="filter"
                    action={<Button variant="outline" onClick={noop}>清除筛选</Button>}
                  />
                  <BusinessFailureState
                    kind="projection"
                    errorCode="QUERY_MODEL_STALE"
                    nextResponsible="平台运维组"
                    action={<Button variant="outline" onClick={noop}>查看后台任务</Button>}
                  />
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <DraftSaveIndicator state="dirty" message="2 个字段尚未保存" />
                  <SensitiveValue
                ...
                <ValidationSummary
                  issues={[
                    { id: "customer-tax", label: "客户税号", message: "格式不完整" },
                    { id: "delivery-date", label: "履约日期", message: "不能早于订单生效日" },
                  ]}
                  onLocate={noop}
                />
                <FormalActionResult
                  ...
                  actions={<Button variant="outline" size="sm" onClick={noop}>查看任务</Button>}
                />
                <BackgroundJobProgress
                  mode="partialAllowed"
                  status="partial"
                  ...
                  skipped={4}
                  failed={3}
                  action={<Button variant="outline" size="sm" onClick={noop}>下载结果</Button>}
                />
              </div>
            </ShowcaseSection>
            ...
            >
              <div className="grid gap-6 xl:grid-cols-2">
                <BusinessDiffPanel
                  changes={[
                    { id: "amount", field: "含税总额", before: "¥1,260,000.00", after: "¥1,284,650.00", note: "客户追加服务范围" },
                    { id: "owner", field: "销售负责人", before: "赵晨", after: "王敏", note: "责任移交" },
                  ]}
                />
                <AuditTimeline
                  entries={[
                    { id: "audit-01", action: "销售订单生效", operator: "王敏", occurredAt: "2026-07-31T18:12:00+08:00", occurredAtLabel: "07-31 18:12", source: "ERP", note: "版本 v4 生效" },
                    { id: "audit-02", action: "接收商城订单", operator: "商城同步任务", occurredAt: "2026-07-31T16:02:00+08:00", occurredAtLabel: "07-31 16:02", source: "Mall API" },
                  ]}
                />
              </div>
            </ShowcaseSection>
            ...
            >
              <div className="space-y-6">
                <ImportStageIndicator
                  stages={{
                    upload: { status: "complete", description: "已上传 1 个文件" },
                    mapping: { status: "complete", description: "字段映射已确认" },
                    validation: { status: "failed", description: "发现 2 个问题" },
                ...
                <ImportIssueTable
                  issues={[
                    { id: "issue-01", rowNumber: 8, field: "customerCode", errorCode: "MAPPING_REQUIRED", message: "客户编号不存在", repairable: true },
                    { id: "issue-02", rowNumber: 16, field: "amountGross", errorCode: "INVALID_FORMAT", message: "金额必须为十进制字符串", repairable: true },
                  ]}
                />
                <BatchOperationResult
                  succeeded={[{ id: "success-01", label: "SO-20260731-0148", code: "EXPORTED" }]}
                  skipped={[{ id: "skip-01", label: "SO-20260730-0146", detail: "当前状态不允许导出" }]}
                  failed={[{ id: "failed-01", label: "SO-20260731-0147", code: "PERMISSION_DENIED", detail: "无客户敏感字段权限" }]}
                  retryAction={<Button variant="outline" size="sm" onClick={noop}>仅重试失败项</Button>}
                />
              </div>
            </ShowcaseSection>
          </TabsContent>
        ...
        >
          <div className="space-y-2">
            ...
            <BusinessObjectCombobox
              label="选择客户"
              items={[
                { id: "customer-01", code: "CUST-0018", label: "北方能源集团", status: { label: "有效", tone: "success" }, description: "集团客户" },
                { id: "customer-02", code: "CUST-0021", label: "华东数字科技有限公司", status: { label: "待复核", tone: "warning" } },
              ]}
        ...
        >
          <StatusMatrix
            items={[
              ...
              { id: "fulfillment", axis: "履约", status: "部分履约", tone: "warning" },
