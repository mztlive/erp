        ...
        <>
            {taskSalesOrderId ? (
                <Button
                    ...
                    size="sm"
                    variant="outline"
                    render={<Link href={w05Href(taskSalesOrderId, returnTo)} />}
                >
                    查看详情
                </Button>
            ) : null}
    ...
    return (
        <Card size="sm" className={`mt-3 ${surfacePanelClassName}`}>
            ...
            <CardContent className="space-y-3">
                ...
                <Button
                    render={<Link href={w05Href(salesOrderId, returnTo)} />}
                >
                    打开销售单驳回处理
                    <ArrowRightIcon data-icon="inline-end" aria-hidden="true" />
                </Button>
