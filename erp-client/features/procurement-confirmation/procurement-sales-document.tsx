    ...
    <PaperDocument<SubmissionLineView>
      ...
      columns={[
        ...
        },
        {
          ...
          header: "数量",
          cell: (line) => (
            <QuantityValue value={line.committedQuantity} unit={line.unit} />
          ),
          align: "end",
          numeric: true,
        },
        {
          ...
          cell: (line) => (
            <div className="space-y-1">
              <MoneyValue value={line.unitPriceGross} taxBasis="gross" />
              {line.salesTaxRate ? (
        ...
        },
        {
          ...
          header: "销售金额",
          cell: (line) => (
            <MoneyValue value={line.salesAmountGross} taxBasis="gross" />
          ),
          align: "end",
          numeric: true,
        },
            ...
            <div className="whitespace-nowrap">
              <p>
                {line.fulfillmentMode
                  ? FULFILLMENT_MODE_LABEL[line.fulfillmentMode]
                  : "未指定方式"}
              </p>
              <p className="mt-1 text-xs text-muted-foreground">
      ...
      totals={[
        {
          id: "net",
          label: "不含税金额",
          value: <MoneyValue value={submission.netAmount} taxBasis="net" />,
        },
        {
          id: "tax",
          label: "税额",
        ...
        },
        {
          id: "gross",
          label: "价税合计",
          value: <MoneyValue value={submission.grossAmount} taxBasis="gross" />,
          emphasized: true,
        },
      ]}
