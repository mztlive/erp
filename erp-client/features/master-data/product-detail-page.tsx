                                ...
                                <div className="min-w-0 space-y-4">
                                    ...
                                    >
                                        ...
                                        <section className="space-y-3">
                                            <MediaListEditor
                                                label={
                                                    masterDataCopy.fCarouselImages
                                                }
