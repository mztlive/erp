  ...
  products: [
    {
      ...
      keyFacts: [
        ...
        { label: "成本价", value: "¥98.00" },
        { label: "销售价", value: "¥168.00" },
        { label: "主图", value: "ny-box-main.jpg" },
        { label: "轮播图", value: "ny-box-c1.jpg, ny-box-c2.jpg" },
        { label: "详情图", value: "ny-box-d1.jpg" },
    ...
    },
    {
      ...
      keyFacts: [
        ...
        { label: "品牌", value: "明前" },
        { label: "供应商", value: "鲜果直供供应链" },
        { label: "成本价", value: "¥45.00" },
        { label: "销售价", value: "¥88.00" },
        { label: "主图", value: "tea-09-main.jpg" },
    ...
    },
    {
      ...
      keyFacts: [
        ...
        { label: "主图", value: "fruit-old-main.jpg" },
      ],
  ...
  prd_1: {
    ...
    currentRevision: {
      ...
      fields: [
        ...
        { label: "销售价", value: "¥168.00" },
        { label: "主图", value: "ny-box-main.jpg" },
        { label: "轮播图", value: "ny-box-c1.jpg, ny-box-c2.jpg（2 张）" },
        { label: "详情图", value: "ny-box-d1.jpg（1 张）" },
