...
import {
    ...
    type PurchaseOrderApprovalPhase,
} from "@/features/purchase-orders/lib/purchase-order-approval"
 ...
 */
export function PurchaseOrderApprovalArea({
    phase,
    approval,
    documentId,
    workItemId,
    ...
    const allowedActions = mergePurchaseOrderAllowedActions(
