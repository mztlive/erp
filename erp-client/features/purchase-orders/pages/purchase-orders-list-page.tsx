                    ...
                    return (
                        <div className="flex justify-end gap-1">
                            <Button
                                ...
                                size="xs"
                                onClick={() =>
                                    setPreviewId(row.original.purchaseOrderId)
                                }
                            >
                                预览
                            </Button>
                        ...
                        filters={
                            <OptionCombobox
                                ...
                                onValueChange={(v) => {
                                    pushUrl({
                                        status:
                                            (v as PurchaseOrderStatusFilter | null) ??
                                            "all",
                                        page: 1,
                                    })
                                }}
                ...
                <DialogContent className="sm:max-w-lg">
                                  ...
                                  return (
                                      ...
                                      >
                                          ...
                                          <ul className="mt-1 list-disc space-y-0.5 pl-4">
                                              <li>
                                                  销售单 {basis.salesOrderNo}
                                              </li>
                                              <li>
                                                  供应商 {basis.supplierName}
                                              </li>
                                              <li>
                                                  类型{" "}
                                                  {
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            type="button"
                            disabled={
                                !selectedBasisId || createMutation.isPending
                            }
