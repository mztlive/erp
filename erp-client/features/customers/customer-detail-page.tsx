...
import { FilePlus2Icon, PencilIcon, ShoppingCartIcon } from "lucide-react"
import {
    AsyncSectionState,
    BusinessEmptyState,
        ...
        <PageScaffold>
            ...
            >
                ...
                <MetricItem
                    ...
                    value={
                        <MoneyValue
                            value={customer.metrics.receivableBalance}
                        />
                    }
                    detail="客户往来汇总"
                    detailMode="tooltip"
                ...
                <MetricItem
                    ...
                    label="逾期金额"
                    value={
                        <MoneyValue value={customer.metrics.overdueAmount} />
                    }
                    detailMode="none"
                />
            </MetricStrip>
