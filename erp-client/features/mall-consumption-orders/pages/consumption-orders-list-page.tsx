            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <BusinessStatusBadge
                        ...
                        label={
                            ATTRIBUTION_STATUS_LABEL[
                                row.original.attributionStatus
                            ]
                        }
                        tone={
                            ATTRIBUTION_STATUS_TONE[
              ...
              矛盾组合无结果时由「当前筛选无结果」空态解释并引导清除。 */}
                    <MetricStrip columns={5} aria-label="消费订单指标筛选">
                        <MetricFilterItem
                            ...
                            title={
                                periodSelected ? undefined : "选择期间后可筛选"
                            }
                            onClick={() =>
                                replaceParams({
                                    metric:
                                        metric === "paid" ? undefined : "paid",
                                })
                            }
                        />
                        <MetricFilterItem
                                    ...
                                    secondary={
                                        <>
                                            ...
                                            <MultiOptionCombobox
                                                ...
                                                options={FACT_TYPES.map(
                                                    (t) => ({
                                                        value: t,
                                                        label: FACT_TYPE_LABEL[
                                                            t
                                                        ],
                                                    }),
                                                )}
                                            ...
                                            <MultiOptionCombobox
                                                ...
                                                options={SUPPLIER_STATUSES.map(
                                                    (s) => ({
                                                        value: s,
                                                        label: SUPPLIER_STATUS_LABEL[
                                                            s
                                                        ],
                                                    }),
                                                )}
