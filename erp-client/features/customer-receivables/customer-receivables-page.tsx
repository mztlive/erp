        ...
        <PageScaffold density="compact">
            ...
            <QuickPreviewSheet
                ...
                identity={
                    detailQuery.data?.receivable ? (
                        <span>
                            {detailQuery.data.receivable.counterpartyPartyName}
                        </span>
                    ) : detailQuery.data?.receipt ? (
                        <span>
                            {detailQuery.data.receipt.counterpartyPartyName}
                        </span>
                    ) : detailQuery.data?.invoice ? (
                        <span>
                            {detailQuery.data.invoice.counterpartyPartyName}
                        </span>
                    ) : null
                }
                summary={
                    detailQuery.data?.receivable ? (
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <Badge>
                                {detailQuery.data.invoice.invoiceKindLabel}
                            </Badge>
                        </div>
                    ) : null
                }
                                    ...
                                    onClick={() =>
                                        setReverseConfirm({
                                            ...
                                            sourceFactId:
                                                detailQuery.data!.receipt!
                                                    .receiptId,
                                            label: detailQuery.data!.receipt!
                                                .receiptNo,
                                            amount: detailQuery.data!.receipt!
                                                .amount,
                                        })
                                    }
                                >
                                    ...
                                    onClick={() => {
                                        ...
                                        setReverseConfirm({
                                            ...
                                            sourceFactId:
                                                detailQuery.data!.invoice!
                                                    .invoiceId,
                                            label: detailQuery.data!.invoice!
                                                .invoiceNo,
                                            amount: detailQuery.data!.invoice!
                                                .allocatedTotal,
                                        })
                                    }}
                                >
                ...
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button
                            type="button"
                            disabled={
                                !selectedPartyId || createSession.isPending
                            }
                            onClick={() =>
                                void startSession(
                                    partyPickerMode,
