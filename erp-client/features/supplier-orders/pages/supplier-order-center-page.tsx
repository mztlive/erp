...
export function SupplierOrderCenterPage({
    ...
    const totalCostGross = detail.items.every(
        (item) => item.unitCostGross == null,
    )
        ? null
        : detail.items
              .reduce(
        ...
        <PageScaffold>
                ...
                primaryAction={
                    isResultUnknown ? (
                        <GuardedBusinessAction
                            ...
                            size="sm"
                            disabled={
                                !canQuery || queryResultMutation.isPending
                            }
                            reason={
                                !canQuery
                    ...
                    <div className="flex flex-wrap gap-2">
                        {isResultUnknown ? (
                            <GuardedBusinessAction
                                ...
                                variant="outline"
                                disabled={
                                    !canReplay || replayMutation.isPending
                                }
                                reason={
                                    canReplay
                                        ? "已确认无结果，可安全重发"
            ...
            <Alert variant="info">
                ...
                <AlertDescription className="text-xs leading-relaxed">
                    ...
                    <span className="num">
                        {formatDateTime(o.paidAt, "fullIntl", "passthrough")}
                    </span>
                </AlertDescription>
            </Alert>
                    ...
                    <AlertDescription className="text-xs leading-relaxed">
                        ...
                        {detail.lastInvestigation ? (
                            <span className="mt-1 block">
                                最近查询：
                                {detail.lastInvestigation.outcomeLabel} —{" "}
                        ...
                        >
                            <DescriptionList className="gap-y-3">
                                ...
                                <Item
                                    ...
                                    value={
                                        <span className="num">
                                            {codeVersion(o.publicationVersion)}
                                        </span>
                                    }
                                />
                                <Item
                    ...
                    {activeSection === "fulfillment" ? (
                        ...
                        >
                            <DescriptionList className="mb-4 gap-y-3">
                                ...
                                <Item
                                    label="承运商"
                                    value={detail.logistics.carrier ?? "—"}
                                />
                                <Item
                                    label="物流号"
                                    value={
                            ...
                            >
                                ...
                                <CardContent className="space-y-2 text-sm">
                                    ...
                                    <div>
                                        手机：
                                        <span className="num">
                                            {detail.address.phoneRevealed ??
                                                detail.address.phoneMasked}
                                        </span>
                                    </div>
                                    <div>
                                        地址：
                        ...
                        >
                            <DescriptionList className="gap-y-3">
                                <Item
                                    label="累计成本（含税）"
                                    value={
                                        detail.costs.cumulativeCostGross ==
                                        null ? (
                                            <span className="text-muted-foreground">
                                                —
                                            </span>
                                ...
                                <Item
                                    label="累计成本（不含税）"
                                    value={
                                        detail.costs.cumulativeCostNet ==
                                        null ? (
                                            <span className="text-muted-foreground">
                                                —
                                            </span>
                                ...
                                <Item
                                    label="应付入口"
                                    value={
                                        detail.costs.payableEntryLabel ?? "—"
                                    }
                                />
                            </DescriptionList>
                            <div className="mt-4 flex flex-wrap gap-2">
                                <Button
                                    ...
                                    variant="outline"
                                    render={
                                        <Link href="/supplier-api/settlements" />
                                    }
                                >
                                    打开 API 结算
                                </Button>
                                <Button
                                    ...
                                    variant="outline"
                                    render={
                                        <Link href="/finance/supplier-accounts" />
                                    }
                                >
                                    供应商往来
                                </Button>
            ...
            <FormalActionConfirmDialog
                ...
                effects={[
                    `引用售后请求 ${afterSalesConfirm?.mallRequestRef ?? "—"}`,
                    "重复提交返回原结果，不会重复发起",
                ]}
                irreversibleEffects={[
                    `将向供应商发起${
