...
export const SUPPLIERS = [
  ...
  { supplierId: "sup_sn", supplierName: "苏宁企业购" },
] as const
...
export const SEED_STATEMENTS: SeedStatement[] = [
  {
    ...
    items: [
      item({
        itemId: "it1",
        supplierOrderNo: "SFO-20260729-0033",
      ...
      item({
        itemId: "it2",
        supplierOrderNo: "SFO-20260801-0001",
  ...
  },
  {
    ...
    items: [
      item({
        itemId: "sf7_1",
        supplierOrderNo: "SFO-20260730-0088",
  ...
  {
    statementId: "st_xg_202607",
    statementNo: "ST-2026-07-XG",
    supplierId: "sup_xg",
    ...
    periodLabel: "2026-07",
    status: "HAS_DIFFERENCE",
    externalBillNo: "XG-BILL-202607",
    externalBillVersion: "v1",
    orderAmountGross: "122944.00",
    freightGross: "15260.00",
    serviceFeeGross: "0.00",
    refundGross: "0.00",
    erpAmountGross: "138204.00",
    supplierAmountGross: "138524.00",
    differenceAmountGross: "320.00",
    preparedBy: { ...ACTORS.prep },
    lockVersion: 3,
    subjectHash: "sh_xg_202607_draft",
    sourceAsOf: "2026-08-01T08:00:00+08:00",
    sourceSnapshotAt: "2026-08-01T08:00:00+08:00",
    sourceSnapshotHash: "ssh_xg_202607_a1b2c3",
    pendingCostDeltaGross: "320.00",
    items: [
      item({
        itemId: "xg1",
        supplierOrderNo: "SO-XG-77101",
        purchaseNo: "CG20260328001",
        purchaseOrderId: "po_01",
        externalOrderNo: "XG-EX-9201",
        productName: "时令鲜果礼盒 A",
        quantity: "200",
        factLabel: "已完成",
        orderAmountGross: "94920.00",
        freightGross: "15260.00",
        serviceFeeGross: "0.00",
        refundGross: "0.00",
        erpAmountGross: "110180.00",
        supplierBillLineGross: "110500.00",
      }),
      item({
        itemId: "xg2",
        supplierOrderNo: "SO-XG-77102",
        purchaseNo: "CG20260320015",
        purchaseOrderId: "po_07",
        externalOrderNo: "XG-EX-9202",
        productName: "季度水果补给箱",
        quantity: "80",
        factLabel: "已完成",
        orderAmountGross: "28024.00",
        freightGross: "0.00",
        serviceFeeGross: "0.00",
        refundGross: "0.00",
        erpAmountGross: "28024.00",
        supplierBillLineGross: "28024.00",
      }),
    ],
    differences: [
      {
        differenceId: "df_xg_amt",
        type: "AMOUNT",
        status: "PENDING",
        blocking: true,
        erpSideLabel: "ERP 明细汇总（含税）",
        erpSideAmount: "138204.00",
        supplierSideLabel: "供应商账单行（含税）",
        supplierSideAmount: "138524.00",
        amountDirectionLabel: "供应商账单高于 ERP",
        amountGross: "320.00",
        version: 1,
        requiresProcurementEvidence: true,
    ...
    auditEvents: [
      {
        ...
        action: "CREATE_DRAFT",
        summary: "按期间策略 v3 创建草稿并冻结来源数据",
        auditNo: "AUD-W27-0705",
      },
      {
        eventId: "ae_xg2",
        at: "2026-08-01T08:00:00+08:00",
        actor: "李经办",
        action: "REFRESH_TRIAL",
        summary: "刷新试算 · sourceSnapshotHash=ssh_xg_202607_a1b2c3",
        auditNo: "AUD-W27-0706",
      },
    ],
  },
]
