...
export const DEFAULT_REFRESH_CUTOFF = {
  ...
  policyVersion: "2",
  label: "提交复核前冻结：含当日 18:00 前不可变事实与账单版本",
}
    ...
    auditEvents: [
      {
        ...
        summary: "提交复核 · subjectHash=sh_mt_202607_sub",
